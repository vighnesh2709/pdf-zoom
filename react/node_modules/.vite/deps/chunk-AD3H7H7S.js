...
// node_modules/@cyntler/react-doc-viewer/dist/index-Cfl95pw4.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);
var H1 = Object.defineProperty;
var U1 = (r, t, e) => t in r ? H1(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e;
var dt = (r, t, e) => (U1(r, typeof t != "symbol" ? t + "" : t, e), e);
var xp = (r, t, e) => {
  if (!t.has(r))
    throw TypeError("Cannot " + e);
};
var o = (r, t, e) => (xp(r, t, "read from private field"), e ? e.call(r) : t.get(r));
var m = (r, t, e) => {
  if (t.has(r))
...
var ng = sy.call;
var Y1 = ry && sy.bind.bind(ng, ng);
var Wi = ry ? Y1 : function(r) {
  return function() {
...
var ly = function(r) {
  if (rA(r))
    throw new sA("Can't call method on " + r);
  return r;
};
var aA = iA;
var oA = ly;
...
var cy = function(r, t) {
  return arguments.length < 2 ? hA(Pp[r]) : Pp[r] && Pp[r][t];
};
var dA = Wi;
var uA = dA({}.isPrototypeOf);
var fA = typeof navigator < "u" && String(navigator.userAgent) || "";
var hy = ii;
var Rp = fA;
var L0 = hy.process;
var k0 = hy.Deno;
var I0 = L0 && L0.versions || k0 && k0.version;
var F0 = I0 && I0.v8;
var Pn;
var Yd;
...
var mA = ii;
var vA = mA.String;
var dy = !!Object.getOwnPropertySymbols && !gA(function() {
  var r = Symbol("symbol detection");
  return !vA(r) || !(Object(r) instanceof Symbol) || // Chrome 38-40 symbols are not inherited from DOM collections prototypes to instances
  !Symbol.sham && M0 && M0 < 41;
});
var yA = dy;
var uy = yA && !Symbol.sham && typeof Symbol.iterator == "symbol";
var bA = cy;
var wA = ri;
var AA = uA;
var EA = uy;
var _A = Object;
var fy = EA ? function(r) {
  return typeof r == "symbol";
} : function(r) {
  var t = bA("Symbol");
  return wA(t) && AA(t.prototype, _A(r));
};
var SA = String;
var xA = function(r) {
  try {
...
var py = function(r) {
  if (CA(r))
    return r;
  throw new PA(TA(r) + " is not a function");
};
var RA = py;
var LA = oy;
var kA = function(r, t) {
  var e = r[t];
  return LA(e) ? void 0 : RA(e);
};
var Lp = Gm;
var kp = ri;
var Ip = Yh;
...
var FA = function(r, t) {
  ...
  if (t === "string" && kp(e = r.toString) && !Ip(n = Lp(e, r)) || kp(e = r.valueOf) && !Ip(n = Lp(e, r)) || t !== "string" && kp(e = r.toString) && !Ip(n = Lp(e, r)))
    return n;
  throw new IA("Can't convert object to primitive value");
};
var gy = { exports: {} };
var D0 = ii;
...
var qm = function(r, t) {
  try {
    MA(D0, r, { value: t, configurable: true, writable: true });
  } catch {
    D0[r] = t;
  }
  return t;
...
var HA = Wi;
var UA = $A;
var jA = HA({}.hasOwnProperty);
var sa = Object.hasOwn || function(t, e) {
  return jA(UA(t), e);
};
var zA = Wi;
var VA = 0;
var GA = Math.random();
var WA = zA(1 .toString);
var vy = function(r) {
  return "Symbol(" + (r === void 0 ? "" : r) + ")_" + WA(++VA + GA, 36);
};
var qA = ii;
var XA = my;
var $0 = sa;
...
var ba = qA.Symbol;
var Fp = XA("wks");
var JA = ZA ? ba.for || ba : ba && ba.withoutSetter || YA;
var QA = function(r) {
  return $0(Fp, r) || (Fp[r] = KA && $0(ba, r) ? ba[r] : JA("Symbol." + r)), Fp[r];
};
var tE = Gm;
var H0 = Yh;
var U0 = fy;
...
var iE = QA;
var rE = TypeError;
var sE = iE("toPrimitive");
var aE = function(r, t) {
  if (!H0(r) || U0(r))
    return r;
  var e = eE(r, sE), n;
  if (e) {
    if (t === void 0 && (t = "default"), n = tE(e, r, t), !H0(n) || U0(n))
      return n;
    throw new rE("Can't convert object to primitive value");
  }
  return t === void 0 && (t = "number"), nE(r, t);
};
var oE = aE;
var lE = fy;
var yy = function(r) {
...
var j0 = Yh;
var ig = cE.document;
var hE = j0(ig) && j0(ig.createElement);
var dE = function(r) {
  return hE ? ig.createElement(r) : {};
};
var uE = ra;
var fE = Tr;
var pE = dE;
var by = !uE && !fE(function() {
...
Vm.f = gE ? z0 : function(t, e) {
  ...
  if (AE(t, e))
    return yE(!mE(vE.f, t, e), t[e]);
};
var Xf = {};
var _E = ra;
var SE = Tr;
var xE = _E && SE(function() {
...
var wy = function(r) {
  if (CE(r))
    return r;
  throw new PE(TE(r) + " is not an object");
};
var RE = ra;
var LE = by;
var kE = xE;
...
Xf.f = RE ? kE ? function(t, e, n) {
  ...
  if (rd(t), e = V0(e), rd(n), LE)
    try {
      return Mp(t, e, n);
    } catch {
    }
  if ("get" in n || "set" in n)
    throw new IE("Accessors not supported");
  return "value" in n && (t[e] = n.value), t;
};
var ME = ra;
var DE = Xf;
var OE = iy;
var Ay = ME ? function(r, t, e) {
  return DE.f(r, t, OE(1, e));
} : function(r, t, e) {
  return r[t] = e, r;
};
var Ey = { exports: {} };
...
var BE = rg && Object.getOwnPropertyDescriptor;
var Ym = NE(_y, "name");
var $E = Ym && (function() {
}).name === "something";
var HE = Ym && (!rg || rg && BE(_y, "name").configurable);
var UE = {
  EXISTS: Ym,
  PROPER: $E,
  CONFIGURABLE: HE
...
var zE = ri;
var sg = Xm;
var VE = jE(Function.toString);
zE(sg.inspectSource) || (sg.inspectSource = function(r) {
  return VE(r);
});
var GE = sg.inspectSource;
var WE = ii;
var qE = ri;
var G0 = WE.WeakMap;
var XE = qE(G0) && /native code/.test(String(G0));
var YE = my;
var KE = vy;
var W0 = YE("keys");
var ZE = function(r) {
  return W0[r] || (W0[r] = KE(r));
};
var Sy = {};
var JE = XE;
var xy = ii;
...
var s_ = function(r) {
  return function(t) {
    var e;
    if (!QE(t) || (e = xl(t)).type !== r)
      throw new ag("Incompatible receiver, " + r + " required");
    return e;
  };
};
if (JE || $p.state) {
  kn = $p.state || ($p.state = new i_());
  ...
  ha = e_("state");
  n_[ha] = true, Kd = function(r, t) {
    if (Bp(r, ha))
      throw new ag(q0);
    return t.facade = r, t_(r, ha, t), t;
  }, xl = function(r) {
    return Bp(r, ha) ? r[ha] : {};
  }, Zd = function(r) {
    return Bp(r, ha);
...
var p_ = Km("".replace);
var g_ = Km([].join);
var m_ = og && !o_(function() {
  return vd(function() {
  }, "length", { value: 8 }).length !== 8;
});
var v_ = String(String).split("String");
var y_ = Ey.exports = function(r, t, e) {
  f_(X0(t), 0, 7) === "Symbol(" && (t = "[" + p_(X0(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), e && e.getter && (t = "get " + t), e && e.setter && (t = "set " + t), (!sd(r, "name") || c_ && r.name !== t) && (og ? vd(r, "name", { value: t, configurable: true }) : r.name = t), m_ && e && sd(e, "arity") && r.length !== e.arity && vd(r, "length", { value: e.arity });
  try {
    e && sd(e, "constructor") && e.constructor ? og && vd(r, "prototype", { writable: false }) : r.prototype && (r.prototype = void 0);
  } catch {
  }
  var n = d_(r);
  return sd(n, "source") || (n.source = g_(v_, typeof t == "string" ? t : "")), r;
};
Function.prototype.toString = y_(function() {
  return l_(this) && u_(this).source || h_(this);
}, "toString");
var b_ = Ey.exports;
var w_ = ri;
var A_ = Xf;
var E_ = b_;
var __ = qm;
var S_ = function(r, t, e, n) {
  n || (n = {});
  var i = n.enumerable, s = n.name !== void 0 ? n.name : t;
  if (w_(e) && E_(e, s, n), n.global)
    i ? r[t] = e : __(t, e);
  else {
    try {
...
var I_ = function(r, t) {
  var e = R_(r);
  return e < 0 ? L_(e + t, 0) : k_(e, t);
};
var F_ = Py;
var M_ = Math.min;
var D_ = function(r) {
  var t = F_(r);
  return t > 0 ? M_(t, 9007199254740991) : 0;
};
var O_ = D_;
var N_ = function(r) {
  return O_(r.length);
...
var W_ = function(r, t) {
  var e = z_(r), n = 0, i = [], s;
  for (s in e)
    !Hp(G_, s) && Hp(e, s) && K0(i, s);
  for (; t.length > n; )
    Hp(e, s = t[n++]) && (~V_(i, s) || K0(i, s));
  return i;
};
var q_ = [
  "constructor",
...
var X_ = W_;
var Y_ = q_;
var K_ = Y_.concat("length", "prototype");
...
var eS = wy;
var nS = J_([].concat);
var iS = Z_("Reflect", "ownKeys") || function(t) {
  var e = Q_.f(eS(t)), n = tS.f;
  return n ? nS(e, n(t)) : e;
};
var Z0 = sa;
var rS = iS;
var sS = Vm;
var aS = Xf;
var oS = function(r, t, e) {
  for (var n = rS(t), i = aS.f, s = sS.f, a = 0; a < n.length; a++) {
    var l = n[a];
...
var Kh = function(r, t) {
  var e = uS[dS(r)];
  return e === pS ? true : e === fS ? false : cS(t) ? lS(t) : !!t;
};
var dS = Kh.normalize = function(r) {
  return String(r).replace(hS, ".").toLowerCase();
};
var uS = Kh.data = {};
var fS = Kh.NATIVE = "N";
var pS = Kh.POLYFILL = "P";
var gS = Kh;
var ad = ii;
var mS = Vm.f;
var vS = Ay;
...
var ES = function(r, t) {
  ...
  if (n ? a = ad : i ? a = ad[e] || bS(e, {}) : a = ad[e] && ad[e].prototype, a)
    for (l in t) {
      if (d = t[l], r.dontCallGetSet ? (h = mS(a, l), c = h && h.value) : c = a[l], s = AS(n ? l : e + (i ? "." : "#") + l, r.forced), !s && c !== void 0) {
        if (typeof d == typeof c)
          continue;
        wS(d, c);
      }
      (r.sham || c && c.sham) && vS(d, "sham", true), yS(a, l, d, r);
    }
};
var Ly = {};
var J0 = py;
...
var SS = function(r) {
  ...
  this.promise = new r(function(n, i) {
    if (t !== void 0 || e !== void 0)
      throw new _S("Bad Promise constructor");
    t = n, e = i;
...
var yd = -1;
function RS() {
  !Aa || !$r || (Aa = false, $r.length ? Hi = $r.concat(Hi) : yd = -1, Hi.length && Fy());
}
function Fy() {
  if (!Aa) {
    var r = Iy(RS);
...
Qt.nextTick = function(r) {
  ...
  if (arguments.length > 1)
    for (var e = 1; e < arguments.length; e++)
      t[e - 1] = arguments[e];
  Hi.push(new My(r, t)), Hi.length === 1 && !Aa && Iy(Fy);
};
function My(r, t) {
...
var FS = kS(
  function(r) {
    return IS.test(r) || r.charCodeAt(0) === 111 && r.charCodeAt(1) === 110 && r.charCodeAt(2) < 91;
  }
  /* Z+1 */
);
var Ut = "-ms-";
...
function Ln() {
  return ee = pn < Hy ? pe(Zo, pn++) : 0, Wo++, ee === 10 && (Wo = 1, Kf++), ee;
}
function Xs() {
  return pe(Zo, pn);
}
...
function HS(r) {
  return Kf = Wo = 1, Hy = ti(Zo = r), pn = 0, [];
}
function US(r) {
  return Zo = "", r;
}
...
function WS(r) {
  return US(Ad("", null, null, null, [""], r = HS(r), 0, [0], r));
}
    ...
    switch (y = P, P = Ln()) {
      case 40:
        if (y != 108 && pe(M, f - 1) == 58) {
          bd(M += pt(Up(P), "&", "&\f"), "&\f", Ny(d ? l[d - 1] : 0)) != -1 && (_ = -1);
          break;
        }
      case 34:
      case 39:
      ...
      default:
        ...
        switch (M += Jm(P), P * E) {
          ...
          case 44:
            ...
            break;
          case 64:
            Xs() === 45 && (M += Up(Ln())), g = Xs(), h = f = ti(L = M += GS(wd())), P++;
            break;
          case 45:
            y === 45 && ti(M) == 2 && (E = 0);
        }
...
function qS(r, t, e, n) {
  return Zf(r, t, e, Dy, Jm(BS()), Go(r, 2, -2), 0, n);
}
...
function Uy(r, t, e) {
  switch (OS(r, t)) {
    ...
    case 6968:
    case 2756:
      return Rt + r + Al + r + Ut + r + r;
    case 5936:
      switch (pe(r, t + 11)) {
        case 114:
          return Rt + r + Ut + pt(r, /[svh]\w+-[tblr]{2}/, "tb") + r;
        case 108:
          return Rt + r + Ut + pt(r, /[svh]\w+-[tblr]{2}/, "tb-rl") + r;
        case 45:
          return Rt + r + Ut + pt(r, /[svh]\w+-[tblr]{2}/, "lr") + r;
      }
    case 6828:
    case 4268:
    case 2903:
      return Rt + r + Ut + r + r;
    case 6165:
      return Rt + r + Ut + "flex-" + r + r;
    case 5187:
      return Rt + r + pt(r, /(\w+).+(:[^]+)/, Rt + "box-$1$2" + Ut + "flex-$1$2") + r;
    case 5443:
      return Rt + r + Ut + "flex-item-" + pt(r, /flex-|-self/g, "") + (li(r, /flex-|baseline/) ? "" : Ut + "grid-row-" + pt(r, /flex-|-self/g, "")) + r;
    case 4675:
      return Rt + r + Ut + "flex-line-pack" + pt(r, /align-content|flex-|-self/g, "") + r;
    case 5548:
      return Rt + r + Ut + pt(r, "shrink", "negative") + r;
    case 5292:
      return Rt + r + Ut + pt(r, "basis", "preferred-size") + r;
    case 6060:
      return Rt + "box-" + pt(r, "-grow", "") + Rt + r + Ut + pt(r, "grow", "positive") + r;
    case 4554:
    ...
    case 4968:
      return pt(pt(r, /(.+:)(flex-)?(.*)/, Rt + "box-pack:$3" + Ut + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + Rt + r + r;
    case 4200:
      if (!li(r, /flex-|baseline/))
        return Ut + "grid-column-align" + Go(r, t) + r;
      break;
    case 2592:
    case 3360:
    ...
    case 3616:
      ...
      }) ? ~bd(r + (e = e[t].value), "span", 0) ? r : Ut + pt(r, "-start", "") + r + Ut + "grid-row-span:" + (~bd(e, "span", 0) ? li(e, /\d+/) : +li(e, /\d+/) - +li(r, /\d+/)) + ";" : Ut + pt(r, "-start", "") + r;
    case 4896:
    case 4128:
    ...
    case 4765:
      if (ti(r) - 1 - t > 6)
        switch (pe(r, t + 1)) {
          ...
          case 115:
            return ~bd(r, "stretch", 0) ? Uy(pt(r, "stretch", "fill-available"), t, e) + r : r;
        }
      break;
    case 5152:
    case 5920:
      return pt(r, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function(n, i, s, a, l, c, d) {
        return Ut + i + ":" + s + d + (a ? Ut + i + "-span:" + (l ? c : +c - +s) + d : "") + r;
      });
    case 4949:
      if (pe(r, t + 6) === 121)
        return pt(r, ":", ":" + Rt) + r;
    ...
    case 6444:
      switch (pe(r, pe(r, 14) === 45 ? 18 : 11)) {
        case 120:
          return pt(r, /(.+:)([^;\s!]+)(;|(\s+)?!.+)?/, "$1" + Rt + (pe(r, 14) === 45 ? "inline-" : "") + "box$3$1" + Rt + "$2$3$1" + Ut + "$2box$3") + r;
        case 100:
          return pt(r, ":", ":" + Ut) + r;
      }
      break;
...
function ZS(r, t, e, n) {
  if (r.length > -1 && !r.return)
    switch (r.type) {
      case Zm:
        r.return = Uy(r.value, r.length, e);
        return;
      case Oy:
        return Jd([Xi(r, { value: pt(r.value, "@", "@" + Rt) })], n);
      case Yf:
        if (r.length)
          return NS(e = r.props, function(i) {
            switch (li(i, n = /(::plac\w+|:read-\w+)/)) {
              ...
              case ":read-write":
                ...
                break;
              case "::placeholder":
                da(Xi(r, { props: [pt(i, /:(plac\w+)/, ":" + Rt + "input-$1")] })), da(Xi(r, { props: [pt(i, /:(plac\w+)/, ":" + Al + "$1")] })), da(Xi(r, { props: [pt(i, /:(plac\w+)/, Ut + "input-$1")] })), da(Xi(r, { props: [i] })), hg(r, { props: Q0(e, n) });
                break;
            }
            return "";
          });
...
var QS = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof ct < "u" && ct.env !== void 0 && ct.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && ct.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? ct.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && ct.env.REACT_APP_SC_DISABLE_SPEEDY : typeof ct < "u" && ct.env !== void 0 && ct.env.SC_DISABLE_SPEEDY !== void 0 && ct.env.SC_DISABLE_SPEEDY !== "" ? ct.env.SC_DISABLE_SPEEDY !== "false" && ct.env.SC_DISABLE_SPEEDY : ct.env.NODE_ENV !== "production");
    ...
    try {
      ...
      console.error = function(a) {
        for (var l = [], c = 1; c < arguments.length; c++)
          l[c - 1] = arguments[c];
        nv.test(a) ? (s = false, od.delete(n)) : i.apply(void 0, Zs([a], l, false));
      }, (0, import_react.useRef)(), s && !od.has(n) && (console.warn(n), od.add(n));
    } catch (a) {
...
var ix = /(^-|-$)/g;
function iv(r) {
  return r.replace(nx, "-").replace(ix, "");
}
var rx = /(a)(d)/gi;
var ld = 52;
var rv = function(r) {
...
function pg(r) {
  ...
  for (t = Math.abs(r); t > ld; t = t / ld | 0)
    e = rv(t % ld) + e;
  return (rv(t % ld) + e).replace(rx, "$1-$2");
}
var jp;
var Vy = 5381;
var Or = function(r, t) {
...
var Yy = Xy ? Symbol.for("react.memo") : 60115;
var sx = Xy ? Symbol.for("react.forward_ref") : 60112;
...
var ox = { name: true, length: true, prototype: true, caller: true, callee: true, arguments: true, arity: true };
var Ky = { $$typeof: true, compare: true, defaultProps: true, displayName: true, propTypes: true, type: true };
var lx = ((jp = {})[sx] = { $$typeof: true, render: true, defaultProps: true, displayName: true, propTypes: true }, jp[Yy] = Ky, jp);
function sv(r) {
  return ("type" in (t = r) && t.type.$$typeof) === Yy ? Ky : "$$typeof" in r ? lx[r.$$typeof] : ax;
  var t;
}
var cx = Object.defineProperty;
var hx = Object.getOwnPropertyNames;
...
function Zy(r, t, e) {
  if (typeof t != "string") {
    ...
    for (var s = sv(r), a = sv(t), l = 0; l < i.length; ++l) {
      var c = i[l];
      if (!(c in ox || e && e[c] || a && c in a || s && c in s)) {
        var d = dx(t, c);
        try {
          cx(r, c, d);
        } catch {
...
function mg(r, t, e) {
  if (e === void 0 && (e = false), !e && !Xo(r) && !Array.isArray(r))
    return t;
  if (Array.isArray(t))
...
var fx = ct.env.NODE_ENV !== "production" ? { 1: `Cannot create styled-component for component: %s.
...
function ji(r) {
  for (var t = [], e = 1; e < arguments.length; e++)
    t[e - 1] = arguments[e];
  return ct.env.NODE_ENV === "production" ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(r, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(px.apply(void 0, Zs([fx[r]], t, false)).trim());
}
var gx = function() {
  function r(t) {
...
var cd = function(r) {
  ...
  for (; Qd.has(_d); )
    _d++;
  var t = _d++;
  if (ct.env.NODE_ENV !== "production" && ((0 | t) < 0 || t > mx))
    throw ji(16, "".concat(t));
...
var yx = "style[".concat(Js, "][").concat(zy, '="').concat(Qf, '"]');
var bx = new RegExp("^".concat(Js, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'));
var wx = function(r, t, e) {
  ...
  for (var e, n = ((e = t.textContent) !== null && e !== void 0 ? e : "").split(Qm), i = [], s = 0, a = n.length; s < a; s++) {
    ...
    if (l) {
      ...
      if (c) {
        ...
        d !== 0 && (vx(h, d), wx(r, h, c[3]), r.getTag().insertRules(d, i)), i.length = 0;
      } else
        i.push(l);
    }
  }
...
var lv = t0;
var Cx = { isServer: !t0, useCSSOMInjection: !QS };
var Qy = function() {
  function r(t, e, n) {
    t === void 0 && (t = qo), e === void 0 && (e = {});
    var i = this;
    this.options = Te(Te({}, Cx), t), this.gs = e, this.names = new Map(n), this.server = !!t.isServer, !this.server && t0 && lv && (lv = false, function(s) {
      for (var a = document.querySelectorAll(yx), l = 0, c = a.length; l < c; l++) {
        var d = a[l];
        d && d.getAttribute(Js) !== jy && (Ax(s, d), d.parentNode && d.parentNode.removeChild(d));
      }
  ...
  return r.registerId = function(t) {
    ...
    return this.tag || (this.tag = (t = function(e) {
      ...
      return e.isServer ? new xx(i) : n ? new _x(i) : new Sx(i);
    }(this.options), new gx(t)));
    var t;
...
function Rx(r) {
  ...
  h.push(function(g) {
    g.type === Yf && g.value.includes("&") && (g.props[0] = g.props[0].replace(Tx, e).replace(n, d));
  }), a.prefix && h.push(ZS), h.push(XS);
  var f = function(g, v, y, E) {
    v === void 0 && (v = ""), y === void 0 && (y = ""), E === void 0 && (E = "&"), t = E, e = v, n = new RegExp("\\".concat(e, "\\b"), "g");
    var x = g.replace(Px, ""), _ = WS(y || v ? "".concat(y, " ").concat(v, " { ").concat(x, " }") : x);
    a.namespace && (_ = tb(_, a.namespace));
    var P = [];
    return Jd(_, YS(h.concat(KS(function(L) {
      return P.push(L);
    })))), P;
  };
...
var ib = function(r) {
  ...
  for (var i in r) {
    var s = r[i];
    r.hasOwnProperty(i) && !nb(s) && (Array.isArray(s) && s.isCss || Qs(s) ? n.push("".concat(hv(i), ":"), s, ";") : Xo(s) ? n.push.apply(n, Zs(Zs(["".concat(i, " {")], ib(s), false), ["}"], false)) : n.push("".concat(hv(i), ": ").concat((t = i, (e = s) == null || typeof e == "boolean" || e === "" ? "" : typeof e != "number" || e === 0 || t in JS || t.startsWith("--") ? String(e).trim() : "".concat(e, "px")), ";")));
  }
  return n;
};
function Ys(r, t, e, n) {
...
var Mx = function() {
  function r(t, e, n) {
    this.rules = t, this.staticRulesId = "", this.isStatic = ct.env.NODE_ENV === "production" && (n === void 0 || n.isStatic) && Ix(t), this.componentId = e, this.baseHash = Or(Fx, e), this.baseStyle = n, Qy.registerId(e);
  }
  return r.prototype.generateAndInjectStyles = function(t, e, n) {
    ...
    if (this.isStatic && !n.hash)
      ...
      if (d) {
        var v = pg(c >>> 0);
        e.hasNameForId(this.componentId, v) || e.insertRules(this.componentId, v, n(d, ".".concat(v), void 0, this.componentId)), i = Hr(i, v);
      }
    }
    return i;
  }, r;
...
function Ox(r, t, e) {
  ...
  var _ = new Mx(e, g, n ? i.componentStyle : void 0);
  function P(k, F) {
    return function(I, M, C) {
      var T = I.attrs, O = I.componentStyle, D = I.defaultProps, U = I.foldedComponentIds, j = I.styledComponentId, V = I.target, Y = import_react.default.useContext(tu), Z = cv(), $ = I.shouldForwardProp || Z.shouldForwardProp;
      ct.env.NODE_ENV !== "production" && (0, import_react.useDebugValue)(j);
      var G = ex(M, Y, D) || qo, W = function(et, lt, K) {
        for (var gt, q = Te(Te({}, lt), { className: void 0, theme: K }), J = 0; J < et.length; J += 1) {
          var ht = Qs(gt = et[J]) ? gt(q) : gt;
          for (var ft in ht)
            q[ft] = ft === "className" ? Hr(q[ft], ht[ft]) : ft === "style" ? Te(Te({}, q[ft]), ht[ft]) : ht[ft];
        }
        return lt.className && (q.className = Hr(q.className, lt.className)), q;
      }(T, M, G), bt = W.as || V, ut = {};
      for (var z in W)
        W[z] === void 0 || z[0] === "$" || z === "as" || z === "theme" && W.theme === G || (z === "forwardedAs" ? ut.as = W.forwardedAs : $ && !$(z, bt) || (ut[z] = W[z], $ || ct.env.NODE_ENV !== "development" || FS(z) || dv.has(z) || !fg.has(bt) || (dv.add(z), console.warn('styled-components: it looks like an unknown prop "'.concat(z, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
  ...
  P.displayName = f;
  var L = import_react.default.forwardRef(P);
  return L.attrs = v, L.componentStyle = _, L.displayName = f, L.shouldForwardProp = y, L.foldedComponentIds = n ? Hr(i.foldedComponentIds, i.styledComponentId) : "", L.styledComponentId = g, L.target = n ? i.target : r, Object.defineProperty(L, "defaultProps", { get: function() {
  ...
  } }), ct.env.NODE_ENV !== "production" && (tx(f, g), L.warnTooManyClasses = /* @__PURE__ */ function(k, F) {
    var I = {}, M = false;
    return function(C) {
...
Example:
  ...
  }), s && Zy(L, r, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), L;
}
function uv(r, t) {
...
var Bx = "Document {{ currentFileNo }} of {{ allFilesCount }}";
var $x = "No renderer for file type: {{{ fileType }}}";
var Hx = "Download file";
var Ux = "Your file is broken. Please check it on your machine.";
var jx = "Recipients";
var zx = "Sender";
var Vx = "Loading...";
var Gx = "Page {{ currentPage }}/{{ allPagesCount }}";
var Wx = {
  documentNavInfo: Bx,
  noRendererMessage: $x,
  ...
  msgPluginSender: zx,
  pdfPluginLoading: Vx,
  pdfPluginPageNumber: Gx
};
var qx = "Dokument {{ currentFileNo }} z {{ allFilesCount }}";
var Xx = "Brak funckji renderującej dla: {{{ fileType }}}";
var Yx = "Pobierz plik";
var Kx = "Twój plik jest uszkodzony. Sprawdź go na swoim komputerze.";
var Zx = "Odbiorcy";
var Jx = "Nadawca";
var Qx = "Wczytywanie...";
var tC = "Strona {{ currentPage }}/{{ allPagesCount }}";
var eC = {
  documentNavInfo: qx,
  noRendererMessage: Xx,
  downloadButtonLabel: Yx,
  brokenFile: Kx,
  msgPluginRecipients: Zx,
  msgPluginSender: Jx,
  pdfPluginLoading: Qx,
  pdfPluginPageNumber: tC
};
var nC = "Documento {{ currentFileNo }} de {{ allFilesCount }}";
var iC = "No hay procesador para el tipo de archivo: {{{ fileType }}}";
var rC = "Descargar archivo";
var sC = "Tu archivo está roto. Compruébalo en tu máquina.";
var aC = "Destinatarios";
var oC = "Remitente";
var lC = "Cargando...";
var cC = "Página {{ currentPage }}/{{ allPagesCount }}";
var hC = {
  documentNavInfo: nC,
  ...
  msgPluginSender: oC,
  pdfPluginLoading: lC,
  pdfPluginPageNumber: cC
};
var dC = "Dokument {{ currentFileNo }} von {{ allFilesCount }}";
var uC = "Kein Renderer für Dateityp: {{{ fileType }}}";
var fC = "Datei herunterladen";
var pC = "Ihre Datei ist defekt. Bitte überprüfen Sie sie auf Ihrem Rechner.";
var gC = "Empfänger";
var mC = "Absender";
var vC = "Wird geladen...";
var yC = "Seite {{ currentPage }}/{{ allPagesCount }}";
var bC = {
  documentNavInfo: dC,
  noRendererMessage: uC,
  downloadButtonLabel: fC,
  brokenFile: pC,
  msgPluginRecipients: gC,
  msgPluginSender: mC,
  pdfPluginLoading: vC,
  pdfPluginPageNumber: yC
};
var wC = "Documento {{ currentFileNo }} di {{ allFilesCount }}";
var AC = "Nessun renderer per il tipo di file: {{{ fileType }}}";
var EC = "Scarica file";
var _C = "Il tuo file è danneggiato. Controllalo sul tuo computer.";
var SC = "Destinatari";
var xC = "Mittente";
var CC = "Caricamento in corso...";
var TC = "Pagina {{ currentPage }}/{{ allPagesCount }}";
var PC = {
  documentNavInfo: wC,
  noRendererMessage: AC,
  downloadButtonLabel: EC,
  brokenFile: _C,
  msgPluginRecipients: SC,
  msgPluginSender: xC,
  pdfPluginLoading: CC,
  pdfPluginPageNumber: TC
};
var RC = "Documento {{ currentFileNo }} de {{ allFilesCount }}";
var LC = "Nenhum renderizador para o tipo de arquivo: {{{ fileType }}}";
var kC = "Baixar arquivo";
var IC = "Seu arquivo está quebrado. Por favor, verifique-o em sua máquina.";
var FC = "Destinatários";
var MC = "Remetente";
var DC = "Carregando...";
var OC = "Página {{ currentPage }}/{{ allPagesCount }}";
var NC = {
  documentNavInfo: RC,
  ...
  msgPluginSender: MC,
  pdfPluginLoading: DC,
  pdfPluginPageNumber: OC
};
var BC = "Document {{ currentFileNo }} de {{ allFilesCount }}";
var $C = "Aucun moteur de rendu pour le type de fichier : {{{ fileType }}}";
var HC = "Télécharger le fichier";
var UC = "Votre fichier est cassé. Veuillez le vérifier sur votre machine.";
var jC = "Destinataires";
var zC = "Expéditeur";
var VC = "Chargement...";
var GC = "Page {{ currentPage }}/{{ allPagesCount }}";
var WC = {
  documentNavInfo: BC,
  noRendererMessage: $C,
  ...
  msgPluginSender: zC,
  pdfPluginLoading: VC,
  pdfPluginPageNumber: GC
};
var qC = "مستند {{ currentFileNo }} من {{ allFilesCount }}";
var XC = "{{{ fileType }}} : لا يمكننا عرض هذا النوع من الملفات";
var YC = "تحميل الملف";
var KC = "الملف تالف، يرجى التحقق منه على جهازك الخاص.";
var ZC = "المستلمين";
var JC = "المرسل";
var QC = "تحميل ...";
var tT = " {{ allPagesCount }} \\ {{ currentPage }} صفحة ";
var eT = {
  documentNavInfo: qC,
  noRendererMessage: XC,
  downloadButtonLabel: YC,
  brokenFile: KC,
  msgPluginRecipients: ZC,
  msgPluginSender: JC,
  pdfPluginLoading: QC,
  pdfPluginPageNumber: tT
};
var nT = "Dokument {{ currentFileNo }} od {{ allFilesCount }}";
var iT = "Ne postoji pregledač za tip fajla: {{ fileType }}";
var rT = "Preuzimanje fajla";
var sT = "Vaš fajl nije dobar. Molimo Vas da probate da ga otvorite na vašem računaru.";
var aT = "Primaoci";
var oT = "Pošiljalac";
var lT = "Učitavanje...";
var cT = "Strana {{ currentPage }}/{{ allPagesCount }}";
var hT = {
  documentNavInfo: nT,
  noRendererMessage: iT,
  downloadButtonLabel: rT,
  brokenFile: sT,
  msgPluginRecipients: aT,
  msgPluginSender: oT,
  pdfPluginLoading: lT,
  pdfPluginPageNumber: cT
};
var dT = "Документ {{ currentFileNo }} od {{ allFilesCount }}";
var uT = "Не постоји прегледач за тип фајла: {{ fileType }}";
var fT = "Преузимање фајла";
var pT = "Ваш фајл није добар. Молимо Вас да пробате да га отворите на вашем рачунару.";
var gT = "Примаоци";
var mT = "Пошиљалац";
var vT = "Учитавање...";
var yT = "Страна {{ currentPage }}/{{ allPagesCount }}";
var bT = {
  documentNavInfo: dT,
  noRendererMessage: uT,
  downloadButtonLabel: fT,
  brokenFile: pT,
  msgPluginRecipients: gT,
  msgPluginSender: mT,
  pdfPluginLoading: vT,
  pdfPluginPageNumber: yT
};
var wT = "ファイル {{ currentFileNo }} / {{ allFilesCount }}";
var AT = "ファイルタイプに対応したレンダラーはありません: {{ fileType }}";
var ET = "ダウンロード";
var _T = "ファイルが壊れています。あなたのマシンでファイルを確認してください。";
var ST = "受信者";
var xT = "送信者";
var CT = "ローティング中...";
var TT = "ページ {{ currentPage }}/{{ allPagesCount }}";
var PT = {
  documentNavInfo: wT,
  noRendererMessage: AT,
  downloadButtonLabel: ET,
  brokenFile: _T,
  msgPluginRecipients: ST,
  msgPluginSender: xT,
  pdfPluginLoading: CT,
  pdfPluginPageNumber: TT
};
var RT = "Документ {{ currentFileNo }} из {{ allFilesCount }}";
var LT = "Данный тип файла не поддерживается рендером: {{{ fileType }}}";
var kT = "Скачать файл";
var IT = "Ваш файл сломан. Пожалуйста, проверьте его на своём комьютере.";
var FT = "Получатели";
var MT = "Отправитель";
var DT = "Загрузка...";
var OT = "Страница {{ currentPage }}/{{ allPagesCount }}";
var NT = {
  documentNavInfo: RT,
  ...
  msgPluginSender: MT,
  pdfPluginLoading: DT,
  pdfPluginPageNumber: OT
};
var BT = "Dokument {{ currentFileNo }} av {{ allFilesCount }}";
var $T = "Ingen renderare för filtypen: {{{ fileType }}}";
var HT = "Ladda ner";
var UT = "Filen är trasig. Var vänlig kontrollera den på din maskin.";
var jT = "Mottagare";
var zT = "Avsändare";
var VT = "Laddar...";
var GT = "Sida {{ currentPage }}/{{ allPagesCount }}";
var WT = {
  documentNavInfo: BT,
  noRendererMessage: $T,
...
var V2 = Object.keys(eu);
var i0 = "en";
var sb = "SET_ALL_DOCUMENTS";
var ab = "SET_DOCUMENT_LOADING";
var ob = "NEXT_DOCUMENT";
...
var ZT = (0, import_react.forwardRef)((r, t) => {
  const {
    children: e,
    documents: n,
    config: i,
    ...
    activeDocument: h,
    onDocumentChange: f
  } = r, [g, v] = (0, import_react.useReducer)(KT, {
    ...nu,
    documents: n || [],
...
var tP = mt(np)`
  ${QT}
`;
var eP = (r) => (0, import_jsx_runtime.jsx)(fb, { ...r });
var nP = (r) => (0, import_jsx_runtime.jsx)(fb, { ...r, reverse: true });
...
var Jo = Array.isArray || function(t) {
  return rP.call(t) === "[object Array]";
};
function a0(r) {
  return typeof r == "function";
}
...
function vP(r, t) {
  if (!r)
    return [];
  var e = false, n = [], i = [], s = [], a = false, l = false, c = "", d = 0;
  function h() {
    if (a && !l)
      for (; s.length; )
        delete i[s.pop()];
  ...
  var f, g, v;
  function y(C) {
    if (typeof C == "string" && (C = C.split(pP, 2)), !Jo(C) || C.length !== 2)
  ...
  for (var E = new Zh(r), x, _, P, L, k, F; !E.eos(); ) {
    if (x = E.pos, P = E.scanUntil(f), P)
      for (var I = 0, M = P.length; I < M; ++I)
        L = P.charAt(I), hP(L) ? (s.push(i.length), c += L) : (l = true, e = true, c += " "), i.push(["text", L, x, x + 1]), x += 1, L === `
` && (h(), c = "", d = 0, e = false);
    if (!E.scan(f))
      break;
    if (a = true, _ = E.scan(mP) || "name", E.scan(fP), _ === "=" ? (P = E.scanUntil(gv), E.scan(gv), E.scanUntil(g)) : _ === "{" ? (P = E.scanUntil(v), E.scan(gP), E.scanUntil(g), _ = "&") : P = E.scanUntil(g), !E.scan(g))
...
Yo.prototype.lookup = function(t) {
  ...
  if (e.hasOwnProperty(t))
    ...
    for (var i = this, s, a, l, c = false; i; ) {
      if (t.indexOf(".") > 0)
        for (s = i.view, a = t.split("."), l = 0; s != null && l < a.length; )
          l === a.length - 1 && (c = pv(s, a[l]) || aP(s, a[l])), s = s[a[l++]];
      else
...
Ne.prototype.parse = function(t, e) {
  ...
  return a == null && (a = vP(t, e), s && n.set(i, a)), a;
};
...
nn.render = function(t, e, n, i) {
  if (typeof t != "string")
    throw new TypeError('Invalid template! Template should be a "string" but "' + sP(t) + '" was given as the first argument for mustache#render(template, view, partials)');
...
var wP = () => {
  const {
    ...
    dispatch: n
  } = (0, import_react.useContext)(Pr), { t: i } = aa();
  if (e.length <= 1 || !r)
    return null;
  let s = r.uri || "";
  const a = s == null ? void 0 : s.split("/");
  return a.length && (s = a[a.length - 1]), (0, import_jsx_runtime.jsxs)(AP, { id: "doc-nav", children: [
    ...
    (0, import_jsx_runtime.jsx)(
      pb,
      {
        ...
        onClick: () => n(s0()),
        disabled: t === 0,
        children: (0, import_jsx_runtime.jsx)(eP, { color: "#fff", size: "60%" })
      }
    ),
    (0, import_jsx_runtime.jsx)(
      EP,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(nP, { color: "#fff", size: "60%" })
      }
    )
  ] });
};
...
var _P = () => {
  ...
  return (0, import_jsx_runtime.jsx)(SP, { id: "file-name", "data-testid": "file-name", children: e });
};
var SP = mt.div`
  flex: 1;
  text-align: left;
...
var xP = () => {
  ...
  return n || (0, import_jsx_runtime.jsxs)(CP, { id: "header-bar", "data-testid": "header-bar", children: [
    (0, import_jsx_runtime.jsx)(_P, {}),
    (0, import_jsx_runtime.jsx)(wP, {})
  ] });
};
var CP = mt.div`
  display: flex;
...
var TP = (r) => ip({ ...r, readerTypeFunction: "arrayBuffer" });
var mb = (r) => ip({ ...r, readerTypeFunction: "dataURL" });
var vb = (r) => ip({ ...r, readerTypeFunction: "text" });
var G2 = (r) => ip({ ...r, readerTypeFunction: "binaryString" });
var PP = mb;
var RP = () => {
  const {
...
var LP = () => {
  const { state: r, dispatch: t } = (0, import_react.useContext)(Pr), { currentFileNo: e, currentDocument: n, prefetchMethod: i } = r, { CurrentRenderer: s } = RP(), a = (n == null ? void 0 : n.uri) || "";
  return (0, import_react.useEffect)(
    () => {
    ...
    const l = new AbortController(), { signal: c } = l, h = {
      ...
      fileLoaderComplete: (g) => {
        ...
        const v = { ...n };
        g.result !== null && (v.fileData = g.result), t(wg(v)), t(Gp(false));
      },
      headers: r == null ? void 0 : r.requestHeaders
    };
    return s === null ? t(Gp(false)) : s.fileLoader !== void 0 ? (f = s.fileLoader) == null || f.call(s, h) : PP(h), () => {
      l.abort();
    };
...
var mv = ({ children: r }) => {
  ...
  }, [(a = e == null ? void 0 : e.loadingRenderer) == null ? void 0 : a.showLoadingTimeout]), n ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: r }) : null;
};
var IP = ({
  documents: r,
  documentLoading: t,
  ...
  if (r.length)
    if (t) {
      ...
      return (0, import_jsx_runtime.jsx)(mv, { children: (0, import_jsx_runtime.jsx)(DP, { id: "loading-renderer", "data-testid": "loading-renderer", children: (0, import_jsx_runtime.jsx)(NP, { children: (0, import_jsx_runtime.jsx)(iP, { color: "#444", size: 40 }) }) }) });
    } else {
      if (s)
        return (0, import_jsx_runtime.jsx)(s, { mainState: a });
      if (s === void 0)
        return null;
...
var FP = () => {
  var f;
  const { state: r, dispatch: t, CurrentRenderer: e } = LP(), { documents: n, documentLoading: i, currentDocument: s, config: a } = r, l = kP(), { t: c } = aa(), d = (0, import_react.useCallback)(
    (g) => {
      g && t(XT(g == null ? void 0 : g.getBoundingClientRect()));
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [l, t]
  ), h = gb(
    s,
    ((f = a == null ? void 0 : a.header) == null ? void 0 : f.retainURLParams) || false
  );
  return (0, import_jsx_runtime.jsx)(
    MP,
    {
...
var Gi = (r) => {
  ...
  return t ? (0, import_jsx_runtime.jsx)($P, { id: "image-renderer", ...r, children: e || (0, import_jsx_runtime.jsx)(HP, { id: "image-img", src: t.fileData }) }) : null;
};
Gi.fileTypes = [];
Gi.weight = 0;
var $P = mt.div`
...
var HP = mt.img`
  ...
  max-height: 95%;
`;
var o0 = (r) => (0, import_jsx_runtime.jsx)(Gi, { ...r });
...
}, [r]), (0, import_jsx_runtime.jsx)(UP, { id: "html-renderer", children: (0, import_jsx_runtime.jsx)(jP, { id: "html-body", sandbox: "allow-same-origin" }) }));
...
`;
var l0 = (r) => (0, import_jsx_runtime.jsx)(Gi, { ...r });
l0.fileTypes = ["jpg", "jpeg", "image/jpg", "image/jpeg"];
l0.weight = 0;
var sp = ({ mainState: { currentDocument: r } }) => r ? (0, import_jsx_runtime.jsx)(zP, { id: "msdoc-renderer", children: (0, import_jsx_runtime.jsx)(
  VP,
  {
    id: "msdoc-iframe",
    title: "msdoc-iframe",
...
var ei = [];
var on = [];
var GP = typeof Uint8Array < "u" ? Uint8Array : Array;
var qp = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (ua = 0, WP = qp.length; ua < WP; ++ua)
...
(function(r) {
  ...
  h.isBuffer = function(u) {
    ...
    for (let N = 0, H = Math.min(S, R); N < H; ++N)
      if (u[N] !== p[N]) {
        S = u[N], R = p[N];
        break;
      }
    ...
    for (S = 0; S < u.length; ++S) {
      let H = u[S];
      if (at(H, s))
        N + H.length > R.length ? (h.isBuffer(H) || (H = h.from(H)), H.copy(R, N)) : s.prototype.set.call(
          R,
          H,
          N
        );
  ...
  h.prototype.swap16 = function() {
    ...
    if (p >>>= 0, S >>>= 0, R >>>= 0, N >>>= 0, this === u)
      return 0;
    let H = N - R, At = S - p;
    const qt = Math.min(H, At), zt = this.slice(R, N), Xt = u.slice(p, S);
    for (let Ot = 0; Ot < qt; ++Ot)
      if (zt[Ot] !== Xt[Ot]) {
        H = zt[Ot], At = Xt[Ot];
        break;
      }
    return H < At ? -1 : At < H ? 1 : 0;
  };
  ...
  function O(b, u, p, S, R) {
    let N = 1, H = b.length, At = u.length;
    ...
    if (R) {
      ...
      for (p + At > H && (p = H - At), zt = p; zt >= 0; zt--) {
        let Xt = true;
  ...
  function D(b, u, p, S) {
    ...
    let H;
    for (H = 0; H < S; ++H) {
      const At = parseInt(u.substr(H * 2, 2), 16);
      if (Re(At))
        return H;
      b[p + H] = At;
    }
  ...
  function $(b, u, p) {
    ...
    for (; R < p; ) {
      const N = b[R];
      let H = null, At = N > 239 ? 4 : N > 223 ? 3 : N > 191 ? 2 : 1;
      if (R + At <= p) {
        let qt, zt, Xt, Ot;
        switch (At) {
          case 1:
            ...
            break;
          case 2:
            qt = b[R + 1], (qt & 192) === 128 && (Ot = (N & 31) << 6 | qt & 63, Ot > 127 && (H = Ot));
            break;
          case 3:
            qt = b[R + 1], zt = b[R + 2], (qt & 192) === 128 && (zt & 192) === 128 && (Ot = (N & 15) << 12 | (qt & 63) << 6 | zt & 63, Ot > 2047 && (Ot < 55296 || Ot > 57343) && (H = Ot));
            break;
          case 4:
            qt = b[R + 1], zt = b[R + 2], Xt = b[R + 3], (qt & 192) === 128 && (zt & 192) === 128 && (Xt & 192) === 128 && (Ot = (N & 15) << 18 | (qt & 63) << 12 | (zt & 63) << 6 | Xt & 63, Ot > 65535 && Ot < 1114112 && (H = Ot));
        }
      }
      H === null ? (H = 65533, At = 1) : H > 65535 && (H -= 65536, S.push(H >>> 10 & 1023 | 55296), H = 56320 | H & 1023), S.push(H), R += At;
    }
    return W(S);
  }
  const G = 4096;
  ...
  h.prototype.readUintLE = h.prototype.readUIntLE = function(u, p, S) {
    ...
    (p === void 0 || S === void 0) && vt(u, this.length - 8);
    ...
    u = u >>> 0, p = p >>> 0, S || tt(u, p, this.length);
    let R = p, N = 1, H = this[u + --R];
    for (; R > 0 && (N *= 256); )
      H += this[u + --R] * N;
    return N *= 128, H >= N && (H -= Math.pow(2, 8 * p)), H;
  ...
  h.prototype.writeBigUInt64LE = ce(function(u, p = 0) {
    ...
    let N = 0, H = 1, At = 0;
    for (this[p] = u & 255; ++N < S && (H *= 256); )
      u < 0 && At === 0 && this[p + N - 1] !== 0 && (At = 1), this[p + N] = (u / H >> 0) - At & 255;
    return p + S;
  ...
  h.prototype.writeDoubleLE = function(u, p, S) {
    ...
    if (typeof u == "number")
      ...
      const H = h.isBuffer(u) ? u : h.from(u, R), At = H.length;
      if (At === 0)
  ...
  function xt(b, u, p) {
    X(u, "offset"), (b[u] === void 0 || b[u + p] === void 0) && vt(u, b.length - (p + 1));
  }
  function wt(b, u, p, S, R, N) {
    if (b > p || b < u) {
      const H = typeof u == "bigint" ? "n" : "";
      let At;
      throw u === 0 || u === BigInt(0) ? At = `>= 0${H} and < 2${H} ** ${(N + 1) * 8}${H}` : At = `>= -(2${H} ** ${(N + 1) * 8 - 1}${H}) and < 2 ** ${(N + 1) * 8 - 1}${H}`, new ht.ERR_OUT_OF_RANGE("value", At, b);
    }
    xt(S, R, N);
  }
  function X(b, u) {
  ...
  function Lt(b, u) {
    let p, S, R;
    const N = [];
    for (let H = 0; H < b.length && !((u -= 2) < 0); ++H)
      p = b.charCodeAt(H), S = p >> 8, R = p % 256, N.push(R), N.push(S);
    return N;
  }
  function kt(b) {
    return t.toByteArray(Ht(b));
  }
  function Wt(b, u, p, S) {
    let R;
...
var Ag = le.Buffer;
var QP = le.Blob;
var tR = le.BlobOptions;
var eR = le.Buffer;
var nR = le.File;
var iR = le.FileOptions;
var rR = le.INSPECT_MAX_BYTES;
var sR = le.SlowBuffer;
var aR = le.TranscodeEncoding;
var oR = le.atob;
var lR = le.btoa;
var cR = le.constants;
var hR = le.isAscii;
var dR = le.isUtf8;
var uR = le.kMaxLength;
var fR = le.kStringMaxLength;
var pR = le.resolveObjectURL;
var gR = le.transcode;
var q2 = Object.freeze(Object.defineProperty({
  __proto__: null,
  Blob: QP,
  BlobOptions: tR,
  Buffer: eR,
...
Ca = /* @__PURE__ */ new WeakSet(), xd = function(t, e, n, i, s, a, l, c, d, h) {
  if (d <= 0 || d >= 1)
    return;
...
}, Pl = /* @__PURE__ */ new WeakSet(), Cg = function(t, e, n, i, s, a, l, c, d, h, f, g) {
  if (Math.abs(d) < 1e-12) {
...
var oi = "http://www.w3.org/2000/svg";
var Nr = class Nr2 {
};
...
var kR = class extends up {
  ...
  addHighlightHCMFilter(e, n, i, s, a) {
    ...
    const E = (L, k, F) => {
      ...
      let O = 0;
      for (let D = 0; D <= F; D++) {
        const U = Math.round(f + D * M), j = C + D * T;
        for (let V = O; V <= U; V++)
          I[V] = j;
        O = U + 1;
      }
  ...
  destroy(e = false) {
    e && o(this, tr, fa).size !== 0 || (o(this, Dn) && (o(this, Dn).parentNode.parentNode.remove(), w(this, Dn, null)), o(this, Ur) && (o(this, Ur).clear(), w(this, Ur, null)), w(this, jr, 0));
  }
};
Ur = /* @__PURE__ */ new WeakMap(), Dn = /* @__PURE__ */ new WeakMap(), fi = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), du = /* @__PURE__ */ new WeakMap(), jr = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakSet(), Se = function() {
  return o(this, Ur) || w(this, Ur, /* @__PURE__ */ new Map());
}, tr = /* @__PURE__ */ new WeakSet(), fa = function() {
  return o(this, du) || w(this, du, /* @__PURE__ */ new Map());
}, er = /* @__PURE__ */ new WeakSet(), pa = function() {
  if (!o(this, Dn)) {
  ...
  return o(this, Dn);
}, Ta = /* @__PURE__ */ new WeakSet(), Cd = function(e) {
  if (e.length === 1) {
...
}, nr = /* @__PURE__ */ new WeakSet(), ga = function(e) {
...
function ta(r, t, e = false, n = true) {
  if (t instanceof Jh) {
    const {
      pageWidth: i,
      pageHeight: s
...
var vu = class vu2 {
  ...
  render() {
    ...
    t.className = "editToolbar", t.setAttribute("role", "toolbar"), t.addEventListener("contextmenu", Ge), t.addEventListener("pointerdown", A(vu2, fu, Pb));
...
Wr = /* @__PURE__ */ new WeakMap(), qr = /* @__PURE__ */ new WeakMap(), On = /* @__PURE__ */ new WeakMap(), Xr = /* @__PURE__ */ new WeakMap(), fu = /* @__PURE__ */ new WeakSet(), Pb = function(t) {
  ...
  o(this, On)._focusEventsAllowed = false, t.preventDefault(), t.stopPropagation();
}, gu = /* @__PURE__ */ new WeakSet(), Lb = function(t) {
  o(this, On)._focusEventsAllowed = true, t.preventDefault(), t.stopPropagation();
}, Pa = /* @__PURE__ */ new WeakSet(), Td = function(t) {
...
}, mu = /* @__PURE__ */ new WeakSet(), kb = function() {
...
}, kl = /* @__PURE__ */ new WeakSet(), Lg = function() {
...
var HR = class {
  ...
  undo() {
    ...
    t(), e == null || e(), w(this, ir, false), w(this, fe, o(this, fe) - 1);
  }
  redo() {
    if (o(this, fe) < o(this, ue).length - 1) {
      w(this, fe, o(this, fe) + 1), w(this, ir, true);
      const {
        cmd: t,
        post: e
      } = o(this, ue)[o(this, fe)];
...
var wa = class wa2 {
  ...
  static get _keyboardManager() {
    const t = wa2.prototype, e = (a) => o(a, vi).contains(document.activeElement) && document.activeElement.tagName !== "BUTTON" && a.hasSomethingToControl(), n = (a, {
      target: l
    }) => {
  ...
  destroy() {
    ...
    for (const n of o(this, me).values())
      n.destroy();
    o(this, me).clear(), o(this, ie).clear(), o(this, Zr).clear(), w(this, Ye, null), o(this, It).clear(), o(this, vn).destroy(), (t = o(this, Ra)) == null || t.destroy(), (e = o(this, $n)) == null || e.hide(), w(this, $n, null), o(this, Bn) && (clearTimeout(o(this, Bn)), w(this, Bn, null)), o(this, Hn) && (clearTimeout(o(this, Hn)), w(this, Hn, null)), A(this, Ru, $b).call(this);
  }
  async mlGuess(t) {
    var e;
  ...
  highlightSelection(t = "") {
    ...
    if (h) {
      e.empty(), o(this, ve) === _t.NONE && (this._eventBus.dispatch("showannotationeditorui", {
        source: this,
        mode: _t.HIGHLIGHT
  ...
  blur() {
    if (this.isShiftKeyDown = false, o(this, rr) && (w(this, rr, false), A(this, Da, Rd).call(this, "main_toolbar")), !this.hasSelection)
      return;
    const {
      activeElement: t
    } = document;
  ...
  keydown(t) {
    !this.isShiftKeyDown && t.key === "Shift" && (this.isShiftKeyDown = true), o(this, ve) !== _t.NONE && !this.isEditorHandlingKeyboard && wa2._keyboardManager.exec(this, t);
  }
  keyup(t) {
    this.isShiftKeyDown && t.key === "Shift" && (this.isShiftKeyDown = false, o(this, rr) && (w(this, rr, false), A(this, Da, Rd).call(this, "main_toolbar")));
  }
  onEditingAction({
    name: t
  }) {
  ...
  setEditingState(t) {
    t ? (A(this, Lu, Hb).call(this), A(this, sc, Ng).call(this), A(this, ye, ke).call(this, {
      isEditing: o(this, ve) !== _t.NONE,
  ...
  registerEditorTypes(t) {
    if (!o(this, gi)) {
      ...
      for (const e of o(this, gi))
        A(this, Un, Yi).call(this, e.defaultPropertiesToUpdate);
    }
  }
  getId() {
    return o(this, xu).id;
  ...
  updateMode(t, e = null, n = false) {
    if (o(this, ve) !== t) {
      if (w(this, ve, t), t === _t.NONE) {
        this.setEditingState(false), A(this, Iu, jb).call(this);
        return;
      }
      this.setEditingState(true), A(this, ku, Ub).call(this), this.unselectAll();
    ...
    if (o(this, gi)) {
      switch (t) {
        ...
        case ot.HIGHLIGHT_DEFAULT_COLOR:
          (n = o(this, Hl)) == null || n.updateColor(e);
          break;
        case ot.HIGHLIGHT_SHOW_ALL:
          ...
          }), (o(this, Ul) || w(this, Ul, /* @__PURE__ */ new Map())).set(t, e), this.showAllEditors("highlight", e);
          break;
      }
      for (const i of o(this, It))
        i.updateParams(t, e);
  ...
  showAllEditors(t, e, n = false) {
    ...
    (((s = o(this, Ul)) == null ? void 0 : s.get(ot.HIGHLIGHT_SHOW_ALL)) ?? true) !== e && A(this, Un, Yi).call(this, [[ot.HIGHLIGHT_SHOW_ALL, e]]);
  }
  ...
  addDeletedAnnotationElement(t) {
    o(this, Kr).add(t.annotationElementId), this.addChangedExistingAnnotation(t), t.deleted = true;
  }
  isDeletedAnnotationElement(t) {
    return o(this, Kr).has(t);
  }
  removeDeletedAnnotationElement(t) {
    o(this, Kr).delete(t.annotationElementId), this.removeChangedExistingAnnotation(t), t.deleted = false;
  }
  setActiveEditor(t) {
    o(this, Ye) !== t && (w(this, Ye, t), t && A(this, Un, Yi).call(this, t.propertiesToUpdate));
  }
  updateUI(t) {
    o(this, Fu, zb) === t && A(this, Un, Yi).call(this, t.propertiesToUpdate);
  }
  toggleSelected(t) {
    if (o(this, It).has(t)) {
    ...
    o(this, It).add(t), t.select(), A(this, Un, Yi).call(this, t.propertiesToUpdate), A(this, ye, ke).call(this, {
  ...
  setSelected(t) {
    for (const e of o(this, It))
      e !== t && e.unselect();
    o(this, It).clear(), o(this, It).add(t), t.select(), A(this, Un, Yi).call(this, t.propertiesToUpdate), A(this, ye, ke).call(this, {
      hasSelectedEditor: true
    });
  }
  isSelected(t) {
  ...
  selectAll() {
    for (const t of o(this, It))
      t.commit();
    A(this, lc, Hg).call(this, o(this, ie).values());
  }
  unselectAll() {
    if (!(o(this, Ye) && (o(this, Ye).commitOrRemove(), o(this, ve) !== _t.NONE)) && this.hasSelection) {
      for (const t of o(this, It))
        t.unselect();
  ...
  translateSelectedEditors(t, e, n = false) {
    ...
    o(this, Hn) && clearTimeout(o(this, Hn)), w(this, Hn, setTimeout(() => {
      w(this, Hn, null), o(this, ar)[0] = o(this, ar)[1] = 0, this.addCommands({
        cmd: () => {
          for (const c of a)
  ...
  renderAnnotationElement(t) {
    ...
    n && (o(this, ve) === _t.NONE && !n.hasBeenModified || n.renderAnnotationElement(t));
  }
};
Ye = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), Ra = /* @__PURE__ */ new WeakMap(), pi = /* @__PURE__ */ new WeakMap(), La = /* @__PURE__ */ new WeakMap(), vn = /* @__PURE__ */ new WeakMap(), ka = /* @__PURE__ */ new WeakMap(), Kr = /* @__PURE__ */ new WeakMap(), Nn = /* @__PURE__ */ new WeakMap(), gi = /* @__PURE__ */ new WeakMap(), Zr = /* @__PURE__ */ new WeakMap(), Nl = /* @__PURE__ */ new WeakMap(), Bl = /* @__PURE__ */ new WeakMap(), Bn = /* @__PURE__ */ new WeakMap(), Ia = /* @__PURE__ */ new WeakMap(), rr = /* @__PURE__ */ new WeakMap(), $n = /* @__PURE__ */ new WeakMap(), xu = /* @__PURE__ */ new WeakMap(), sr = /* @__PURE__ */ new WeakMap(), $l = /* @__PURE__ */ new WeakMap(), Jr = /* @__PURE__ */ new WeakMap(), Hl = /* @__PURE__ */ new WeakMap(), Fa = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), It = /* @__PURE__ */ new WeakMap(), mi = /* @__PURE__ */ new WeakMap(), Qr = /* @__PURE__ */ new WeakMap(), Ul = /* @__PURE__ */ new WeakMap(), jl = /* @__PURE__ */ new WeakMap(), zl = /* @__PURE__ */ new WeakMap(), Vl = /* @__PURE__ */ new WeakMap(), Gl = /* @__PURE__ */ new WeakMap(), Wl = /* @__PURE__ */ new WeakMap(), ql = /* @__PURE__ */ new WeakMap(), Xl = /* @__PURE__ */ new WeakMap(), Yl = /* @__PURE__ */ new WeakMap(), Kl = /* @__PURE__ */ new WeakMap(), Zl = /* @__PURE__ */ new WeakMap(), Jl = /* @__PURE__ */ new WeakMap(), Ql = /* @__PURE__ */ new WeakMap(), tc = /* @__PURE__ */ new WeakMap(), ar = /* @__PURE__ */ new WeakMap(), Hn = /* @__PURE__ */ new WeakMap(), vi = /* @__PURE__ */ new WeakMap(), ec = /* @__PURE__ */ new WeakMap(), Ma = /* @__PURE__ */ new WeakSet(), Pd = function({
  anchorNode: t
}) {
  ...
  }), !(o(this, ve) !== _t.HIGHLIGHT && o(this, ve) !== _t.NONE) && (o(this, ve) === _t.HIGHLIGHT && this.showAllEditors("highlight", true, true), w(this, rr, this.isShiftKeyDown), !this.isShiftKeyDown)) {
    const c = (d) => {
...
}, Da = /* @__PURE__ */ new WeakSet(), Rd = function(t = "") {
  o(this, ve) === _t.HIGHLIGHT ? this.highlightSelection(t) : o(this, Nl) && A(this, Cu, Ob).call(this);
...
}, ac = /* @__PURE__ */ new WeakSet(), Bg = function() {
...
}, ye = /* @__PURE__ */ new WeakSet(), ke = function(t) {
  ...
  }), o(this, ve) === _t.HIGHLIGHT && t.hasSelectedEditor === false && A(this, Un, Yi).call(this, [[ot.HIGHLIGHT_FREE, true]]));
}, Un = /* @__PURE__ */ new WeakSet(), Yi = function(t) {
...
}, oc = /* @__PURE__ */ new WeakSet(), $g = function(t) {
  ...
  if (o(this, ie).size === 1)
    for (const t of o(this, ie).values())
      return t.isEmpty();
  return false;
}, lc = /* @__PURE__ */ new WeakSet(), Hg = function(t) {
  for (const e of o(this, It))
    e.unselect();
  o(this, It).clear();
  for (const e of t)
...
var ci = class ci2 {
  ...
  async render() {
    ...
    return t.addEventListener("click", n, {
      ...
      i.target === t && i.key === "Enter" && (w(this, Oa, true), n(i));
    }), await A(this, cc, Ug).call(this), t;
  }
  finish() {
  ...
  set data({
    ...
    o(this, yi) === t && o(this, bi) === e || (w(this, yi, t), w(this, bi, e), A(this, cc, Ug).call(this));
  }
  toggle(t = false) {
...
yi = /* @__PURE__ */ new WeakMap(), bi = /* @__PURE__ */ new WeakMap(), yn = /* @__PURE__ */ new WeakMap(), wi = /* @__PURE__ */ new WeakMap(), bn = /* @__PURE__ */ new WeakMap(), Oa = /* @__PURE__ */ new WeakMap(), Ai = /* @__PURE__ */ new WeakMap(), cc = /* @__PURE__ */ new WeakSet(), Ug = async function() {
  var i;
  const t = o(this, yn);
  if (!t)
    return;
...
var Nt = class Nt2 {
  ...
  static get _resizerKeyboardManager() {
    const t = Nt2.prototype._resizeWithKeyboard, e = ea.TRANSLATE_SMALL, n = ea.TRANSLATE_BIG;
  ...
  focusin(t) {
    this._focusEventsAllowed && (o(this, is) ? w(this, is, false) : this.parent.setSelected(this));
  }
  focusout(t) {
    var n;
  ...
  async addAltTextButton() {
    o(this, Ie) || (ru.initialize(Nt2._l10nPromise), w(this, Ie, new ru(this)), await this.addEditToolbar());
  }
  get altTextData() {
    var t;
  ...
  keydown(t) {
    ...
    if (!o(this, wn)) {
      ...
      for (const c of o(this, wn)) {
        ...
        c.setAttribute("role", "spinbutton"), c.addEventListener("keydown", a), c.addEventListener("blur", l), c.addEventListener("focus", A(this, Hu, Yb).bind(this, d)), Nt2._l10nPromise.get(`pdfjs-editor-resizer-label-${d}`).then((h) => c.setAttribute("aria-label", h));
      }
    }
    const n = o(this, wn)[0];
    let i = 0;
    ...
    A(this, bc, Xg).call(this, 0), w(this, Ei, true), o(this, be).firstChild.focus({
      focusVisible: true
  ...
  _reportTelemetry(t, e = false) {
    if (e) {
      ...
      }, Nt2._telemetryTimeout), o(this, cn).set(n, i);
      return;
    }
  ...
  enable() {
    this.div && (this.div.tabIndex = 0), w(this, Na, false);
  }
  disable() {
    this.div && (this.div.tabIndex = -1), w(this, Na, true);
  }
  renderAnnotationElement(t) {
...
wn = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), Na = /* @__PURE__ */ new WeakMap(), es = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), ns = /* @__PURE__ */ new WeakMap(), Ba = /* @__PURE__ */ new WeakMap(), $a = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), hc = /* @__PURE__ */ new WeakMap(), is = /* @__PURE__ */ new WeakMap(), or = /* @__PURE__ */ new WeakMap(), dc = /* @__PURE__ */ new WeakMap(), rs = /* @__PURE__ */ new WeakMap(), Ei = /* @__PURE__ */ new WeakMap(), jn = /* @__PURE__ */ new WeakMap(), Ha = /* @__PURE__ */ new WeakMap(), Ua = /* @__PURE__ */ new WeakMap(), cn = /* @__PURE__ */ new WeakMap(), uc = /* @__PURE__ */ new WeakMap(), Mu = /* @__PURE__ */ new WeakMap(), fc = /* @__PURE__ */ new WeakSet(), jg = function([t, e], n, i) {
...
}, gc = /* @__PURE__ */ new WeakSet(), Vg = function(t) {
  switch (t) {
    case 90: {
      const [e, n] = this.pageDimensions;
      return [0, -e / n, n / e, 0];
...
}, Du = /* @__PURE__ */ new WeakSet(), Vb = function() {
  if (o(this, be))
    return;
...
}, Ou = /* @__PURE__ */ new WeakSet(), Gb = function(t, e) {
  var y;
  e.preventDefault();
  const {
    isMac: n
  ...
  if (e.button !== 0 || e.ctrlKey && n)
    return;
  (y = o(this, Ie)) == null || y.toggle(false);
  ...
  this.parent.togglePointerEvents(false), window.addEventListener("pointermove", i, a), window.addEventListener("contextmenu", Ge);
  ...
  const v = () => {
    var E;
    this.parent.togglePointerEvents(true), (E = o(this, Ie)) == null || E.toggle(true), this._isDraggable = s, window.removeEventListener("pointerup", v), window.removeEventListener("blur", v), window.removeEventListener("pointermove", i, a), window.removeEventListener("contextmenu", Ge), this.parent.div.style.cursor = f, this.div.style.cursor = g, A(this, mc, Gg).call(this, l, c, d, h);
  };
  window.addEventListener("pointerup", v), window.addEventListener("blur", v);
}, mc = /* @__PURE__ */ new WeakSet(), Gg = function(t, e, n, i) {
  ...
  let x, _, P = false, L = false;
  switch (t) {
    case "topLeft":
      P = true, x = ($, G) => [0, 0], _ = ($, G) => [$, G];
      break;
    case "topMiddle":
      x = ($, G) => [$ / 2, 0], _ = ($, G) => [$ / 2, G];
      break;
    case "topRight":
      P = true, x = ($, G) => [$, 0], _ = ($, G) => [0, G];
      break;
    case "middleRight":
      L = true, x = ($, G) => [$, G / 2], _ = ($, G) => [0, G / 2];
      break;
    case "bottomRight":
      P = true, x = ($, G) => [$, G], _ = ($, G) => [0, 0];
      break;
    case "bottomMiddle":
      x = ($, G) => [$ / 2, G], _ = ($, G) => [$ / 2, 0];
      break;
    case "bottomLeft":
      P = true, x = ($, G) => [0, G], _ = ($, G) => [$, 0];
      break;
    case "middleLeft":
      L = true, x = ($, G) => [0, G / 2], _ = ($, G) => [$, G / 2];
      break;
  }
  const k = x(l, c), F = _(l, c);
  let I = v(...F);
  const M = f(s + I[0]), C = f(a + I[1]);
  let T = 1, O = 1, [D, U] = this.screenToPageTranslation(e.movementX, e.movementY);
  if ([D, U] = E(D / n, U / i), P) {
    const $ = Math.hypot(l, c);
    T = O = Math.max(Math.min(Math.hypot(F[0] - k[0] - D, F[1] - k[1] - U) / $, 1 / l, 1 / c), d / l, h / c);
  } else
    L ? T = Math.max(d, Math.min(1, Math.abs(F[0] - k[0] - D))) / l : O = Math.max(h, Math.min(1, Math.abs(F[1] - k[1] - U))) / c;
  ...
  e && (this.div.classList.add("moving"), n = {
    passive: true,
    capture: true
  }, w(this, Ha, t.clientX), w(this, Ua, t.clientY), i = (a) => {
    const {
      clientX: l,
      clientY: c
    } = a, [d, h] = this.screenToPageTranslation(l - o(this, Ha), c - o(this, Ua));
    w(this, Ha, l), w(this, Ua, c), this._uiManager.dragSelectedEditors(d, h);
...
}, Hu = /* @__PURE__ */ new WeakSet(), Yb = function(t) {
  ...
  if (w(this, Ei, false), A(this, bc, Xg).call(this, -1), o(this, ns)) {
    const {
      savedX: t,
      savedY: e,
      savedWidth: n,
...
var v0 = class {
  ...
  setValue(t, e) {
    ...
    if (n !== void 0)
      ...
      i = true, o(this, we).set(t, e);
    i && A(this, Uu, Zb).call(this), e instanceof Ft && typeof this.onAnnotationEditor == "function" && this.onAnnotationEditor(e.constructor._type);
  }
  has(t) {
  ...
  resetModified() {
    o(this, as) && (w(this, as, false), typeof this.onResetModified == "function" && this.onResetModified());
  }
  get print() {
    return new Jb(this);
  }
...
as = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), Uu = /* @__PURE__ */ new WeakSet(), Zb = function() {
  o(this, as) || (w(this, as, true), typeof this.onSetModified == "function" && this.onSetModified());
};
var wc;
...
var jR = class {
    ...
    if (!(!t || o(this, ja).has(t.loadedName))) {
      if (oe(!this.disableFontFace, "loadSystemFont shouldn't be called when `disableFontFace` is set."), this.isFontLoadingAPISupported) {
        ...
        try {
          ...
          yt(`Cannot load system font: ${t.baseFontName}, installing it could help to improve PDF rendering.`), this.removeNativeFontFace(a);
        }
        return;
      }
    ...
    if (this.isFontLoadingAPISupported) {
      ...
      if (n) {
        ...
        try {
          ...
          throw yt(`Failed to load font '${n.family}': '${i}'.`), t.disableFontFace = true, i;
        }
      }
      return;
    }
  ...
  _queueLoadingCallback(t) {
    function e() {
      for (oe(!i.done, "completeRequest() cannot be called twice."), i.done = true; n.length > 0 && n[0].done; ) {
        const s = n.shift();
...
if (Pe) {
  ...
  (async () => {
    const t = await import(
      /*webpackIgnore: true*/
      "./empty-GlqisfcO-ZFUF2APG.js"
    ), e = await import(
      /*webpackIgnore: true*/
      "./index-BIqdkLuE-DWT7RD7J.js"
    ).then((l) => l.i), n = await import(
      /*webpackIgnore: true*/
      "./index-DFn6bF3J-2DKY5VAQ.js"
    ).then((l) => l.i), i = await import(
      /*webpackIgnore: true*/
      "./url-Dkx9cvHv-Y7XZBMJN.js"
    ).then((l) => l.u);
    let s, a;
    ...
    yt(`loadPackages: ${t}`), _l = /* @__PURE__ */ new Map(), Kg.resolve();
  });
}
var Kg;
var _l;
...
var VR = class extends up {
};
var GR = class extends fp {
  _createCanvas(t, e) {
    return ni.get("canvas").createCanvas(t, e);
  }
};
var WR = class extends pp {
  _fetchData(t, e) {
    return Qb(t).then((n) => ({
      cMapData: n,
      compressionType: e
...
var XR = class extends td {
  ...
  getPattern(t, e, n, i) {
    ...
    if (i === De.STROKE || i === De.FILL) {
      const a = e.current.getClippedPathBoundingBox(i, Vt(t)) || [0, 0, 0, 0], l = Math.ceil(a[2] - a[0]) || 1, c = Math.ceil(a[3] - a[1]) || 1, d = e.cachedCanvases.getCanvas("pattern", l, c, true), h = d.context;
...
function Zp(r, t, e, n, i, s, a, l) {
  ...
  if (y >= P)
    return;
  const L = d[s], k = d[s + 1], F = d[s + 2], I = d[a], M = d[a + 1], C = d[a + 2], T = d[l], O = d[l + 1], D = d[l + 2], U = Math.round(y), j = Math.round(P);
  let V, Y, Z, $, G, W, bt, ut;
  for (let z = U; z <= j; z++) {
    if (z < x) {
...
var KR = class extends td {
  ...
  _createMeshCanvas(t, e, n) {
    const l = Math.floor(this._bounds[0]), c = Math.floor(this._bounds[1]), d = Math.ceil(this._bounds[2]) - l, h = Math.ceil(this._bounds[3]) - c, f = Math.min(Math.ceil(Math.abs(d * t[0] * 1.1)), 3e3), g = Math.min(Math.ceil(Math.abs(h * t[1] * 1.1)), 3e3), v = d / f, y = h / g, E = {
      ...
      scaleX: 1 / v,
      scaleY: 1 / y
    }, x = f + 2 * 2, _ = g + 2 * 2, P = n.getCanvas("mesh", x, _, false), L = P.context, k = L.createImageData(f, g);
    if (e) {
      const I = k.data;
...
function Pv(r, t) {
  ...
  const e = t.height, n = t.width, i = e % Ue, s = (e - i) / Ue, a = i === 0 ? s : s + 1, l = r.createImageData(n, Ue);
  let c = 0, d;
  ...
  if (t.kind === Sd.GRAYSCALE_1BPP) {
    ...
    for (g = 0; g < a; g++) {
      ...
      for (; d < P; )
        _[d++] = 0;
      r.putImageData(l, 0, g * Ue);
    }
  } else if (t.kind === Sd.RGBA_32BPP) {
    for (v = 0, E = n * Ue * 4, g = 0; g < s; g++)
      f.set(h.subarray(c, c + E)), c += E, r.putImageData(l, 0, v), v += Ue;
    g < a && (E = n * i * 4, f.set(h.subarray(c, c + E)), r.putImageData(l, 0, v));
  } else if (t.kind === Sd.RGB_24BPP)
    for (y = Ue, E = n * y, g = 0; g < a; g++) {
...
var rL = ["butt", "round", "square"];
var sL = ["miter", "round", "bevel"];
var aL = {};
var kv = {};
var Ac;
var Qg;
...
var T0 = class T02 {
  ...
  stroke(t = true) {
    ...
    e.globalAlpha = this.current.strokeAlpha, this.contentVisible && (typeof n == "object" && (n != null && n.getPattern) ? (e.save(), e.strokeStyle = n.getPattern(e, this, ai(e), De.STROKE), this.rescaleAndStroke(false), e.restore()) : this.rescaleAndStroke(true)), t && this.consumePath(this.current.getClippedPathBoundingBox()), e.globalAlpha = this.current.fillAlpha;
  }
  closeStroke() {
  ...
  fill(t = true) {
    ...
    let s = false;
    i && (e.save(), e.fillStyle = n.getPattern(e, this, ai(e), De.FILL), s = true);
    const a = this.current.getClippedPathBoundingBox();
    this.contentVisible && a !== null && (this.pendingEOFill ? (e.fill("evenodd"), this.pendingEOFill = false) : e.fill()), s && e.restore(), t && this.consumePath(a);
  }
  eoFill() {
  ...
  setFont(t, e) {
    ...
    if (i.fontMatrix = n.fontMatrix || Eg, (i.fontMatrix[0] === 0 || i.fontMatrix[3] === 0) && yt("Invalid font matrix for font " + t), e < 0 ? (e = -e, i.fontDirection = -1) : i.fontDirection = 1, this.current.font = n, this.current.fontSize = e, n.isType3Font)
      return;
  ...
  showText(t) {
    ...
    for (F = 0; F < f; ++F) {
      ...
      if (this.contentVisible && (I.isInFont || n.missingFile)) {
        if (x && !O)
          s.fillText(T, D, U);
        else if (this.paintChar(T, D, U, _), O) {
          const Y = D + i * O.offset.x / a, Z = U - i * O.offset.y / a;
  ...
  showType3Text(t) {
    ...
    if (!(v || s === 0)) {
      for (this._cachedScaleForStroking[0] = -1, this._cachedGetSinglePixelWidth = null, e.save(), e.transform(...n.textMatrix), e.translate(n.x, n.y), e.scale(h, a), y = 0; y < g; ++y) {
        ...
        if (!L) {
          yt(`Type3 character "${E.operatorListId}" is not available.`);
          continue;
        }
  ...
  getColorN_Pattern(t) {
    ...
    if (t[0] === "TilingPattern") {
      const n = t[1], i = this.baseTransform || Vt(this.ctx), s = {
        createCanvasGraphics: (a) => new T02(a, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, {
  ...
  beginGroup(t) {
    ...
    const e = this.ctx;
    t.isolated || cp("TODO: Support non-isolated groups."), t.knockout && yt("Knockout groups not supported.");
    const n = Vt(e);
...
zu = /* @__PURE__ */ new WeakSet(), tw = function(t) {
  const e = t.streamId, n = this.sourceName, i = t.sourceName, s = this.comObj, a = this, l = this.actionHandler[t.action], c = {
    ...
    error(d) {
      oe(d instanceof Error, "error must have a valid reason"), !this.isCancelled && (this.isCancelled = true, s.postMessage({
        sourceName: n,
        targetName: i,
        stream: te.ERROR,
        streamId: e,
...
}, Vu = /* @__PURE__ */ new WeakSet(), ew = function(t) {
  ...
  switch (t.stream) {
    ...
    case te.CLOSE:
      if (oe(a, "close should have stream controller"), a.isClosed)
        break;
      a.isClosed = true, a.controller.close(), A(this, za, Ld).call(this, a, e);
      break;
    case te.ERROR:
...
}, za = /* @__PURE__ */ new WeakSet(), Ld = async function(t, e) {
  var n, i, s;
...
os = /* @__PURE__ */ new WeakMap(), xc = /* @__PURE__ */ new WeakMap();
var Ki = Symbol("INTERNAL");
var Cc;
var Tc;
var Pc;
var Va;
var lL = class {
  ...
  get visible() {
    ...
    return o(this, Cc) ? (e == null ? void 0 : e.viewState) !== "OFF" : o(this, Tc) ? (t == null ? void 0 : t.printState) !== "OFF" : true;
  }
  _setVisible(t, e, n = false) {
    t !== Ki && Dt("Internal method `_setVisible` called."), w(this, Pc, n), w(this, Va, e);
  }
};
Cc = /* @__PURE__ */ new WeakMap(), Tc = /* @__PURE__ */ new WeakMap(), Pc = /* @__PURE__ */ new WeakMap(), Va = /* @__PURE__ */ new WeakMap();
var lr;
var Mt;
var Ga;
var Wa;
...
var cL = class {
  constructor(t, e = un.DISPLAY) {
    ...
    if (this.renderingIntent = e, this.name = null, this.creator = null, t !== null) {
      ...
      for (const n of t.on)
        o(this, Mt).get(n)._setVisible(Ki, true);
      for (const n of t.off)
        o(this, Mt).get(n)._setVisible(Ki, false);
  ...
  isVisible(t) {
    ...
    if (t.type === "OCG")
      return o(this, Mt).has(t.id) ? o(this, Mt).get(t.id).visible : (yt(`Optional content group not found: ${t.id}`), true);
    if (t.type === "OCMD") {
      if (t.expression)
      ...
      if (!t.policy || t.policy === "AnyOn") {
        for (const e of t.ids) {
          if (!o(this, Mt).has(e))
            return yt(`Optional content group not found: ${e}`), true;
      ...
      return yt(`Unknown optional content policy ${t.policy}.`), true;
    }
    return yt(`Unknown group type ${t.type}.`), true;
  }
...
lr = /* @__PURE__ */ new WeakMap(), Mt = /* @__PURE__ */ new WeakMap(), Ga = /* @__PURE__ */ new WeakMap(), Wa = /* @__PURE__ */ new WeakMap(), Rc = /* @__PURE__ */ new WeakSet(), em = function(t) {
  const e = t.length;
  if (e < 2)
    return true;
  const n = t[0];
  for (let i = 1; i < e; i++) {
    ...
    if (Array.isArray(s))
      ...
      return yt(`Optional content group not found: ${s}`), true;
    switch (n) {
      case "And":
        if (!a)
          return false;
...
var au = (je = class {
  constructor({
    ...
    w(this, He, w(this, qa, e)), w(this, hr, n.scale * (globalThis.devicePixelRatio || 1)), w(this, Xa, n.rotation), w(this, _i, {
      prevFontSize: null,
      prevFontFamily: null,
      div: null,
      properties: null,
...
}, cr = /* @__PURE__ */ new WeakMap(), He = /* @__PURE__ */ new WeakMap(), Lc = /* @__PURE__ */ new WeakMap(), kc = /* @__PURE__ */ new WeakMap(), ls = /* @__PURE__ */ new WeakMap(), _i = /* @__PURE__ */ new WeakMap(), Ic = /* @__PURE__ */ new WeakMap(), Fc = /* @__PURE__ */ new WeakMap(), cs = /* @__PURE__ */ new WeakMap(), qa = /* @__PURE__ */ new WeakMap(), Xa = /* @__PURE__ */ new WeakMap(), hr = /* @__PURE__ */ new WeakMap(), Ya = /* @__PURE__ */ new WeakMap(), Mc = /* @__PURE__ */ new WeakMap(), Ka = /* @__PURE__ */ new WeakMap(), hs = /* @__PURE__ */ new WeakMap(), Dc = /* @__PURE__ */ new WeakMap(), Oc = /* @__PURE__ */ new WeakMap(), ds = /* @__PURE__ */ new WeakMap(), us = /* @__PURE__ */ new WeakMap(), Za = /* @__PURE__ */ new WeakMap(), Gu = /* @__PURE__ */ new WeakSet(), cw = function(t) {
  var i, s;
  if (o(this, Lc))
    return;
  ...
  for (const a of t) {
    if (e.length > TL) {
      yt("Ignoring additional textDivs for performance reasons."), w(this, Lc, true);
      return;
    }
    if (a.str === void 0) {
      if (a.type === "beginMarkedContentProps" || a.type === "beginMarkedContent") {
        const l = o(this, He);
        w(this, He, document.createElement("span")), o(this, He).classList.add("markedContent"), a.id !== null && o(this, He).setAttribute("id", `${a.id}`), l.append(o(this, He));
      } else
        a.type === "endMarkedContent" && w(this, He, o(this, He).parentNode);
      continue;
    }
  ...
  o(this, He) === o(this, qa) ? (v.left = `${(100 * h / o(this, Fc)).toFixed(2)}%`, v.top = `${(100 * f / o(this, Ic)).toFixed(2)}%`) : (v.left = `${g}${h.toFixed(2)}px)`, v.top = `${g}${f.toFixed(2)}px)`), v.fontSize = `${g}${c.toFixed(2)}px)`, v.fontFamily = l, n.fontSize = c, e.setAttribute("role", "presentation"), e.textContent = t.str, e.dir = t.dir, o(this, kc) && (e.dataset.fontName = a.fontSubstitutionLoadedName || t.fontName), s !== 0 && (n.angle = s * (180 / Math.PI));
  let y = false;
  if (t.str.length > 1)
    y = true;
  ...
  if (y && (n.canvasWidth = a.vertical ? t.height : t.width), o(this, Dc).set(e, n), o(this, _i).div = e, o(this, _i).properties = n, A(this, Nc, nm).call(this, o(this, _i)), n.hasText && o(this, He).append(e), n.hasEOL) {
    const x = document.createElement("br");
    x.setAttribute("role", "presentation"), o(this, He).append(x);
  }
...
}, Ja = /* @__PURE__ */ new WeakSet(), kd = function(t = null) {
...
var jL = class {
  ...
  render({
    ...
    w(this, Si, false), A(this, Qa, Id).call(this), l || (l = this._transport.getOptionalContentConfig(g));
    ...
    const x = (F) => {
      var I;
      y.renderTasks.delete(_), (this._maybeCleanupAfterRender || E) && w(this, Si, true), A(this, ur, ma).call(this, !E), F ? (_.capability.reject(F), this._abortOperatorList({
        intentState: y,
  ...
  _destroy() {
    ...
    return this.objs.clear(), w(this, Si, false), A(this, Qa, Id).call(this), Promise.all(t);
  }
  cleanup(t = false) {
    w(this, Si, true);
    const e = A(this, ur, ma).call(this, false);
  ...
  _renderPageChunk(t, e) {
    ...
    t.lastChunk && A(this, ur, ma).call(this, true);
  }
  _pumpOperatorList({
    renderingIntent: t,
    cacheKey: e,
...
dr = /* @__PURE__ */ new WeakMap(), Si = /* @__PURE__ */ new WeakMap(), ur = /* @__PURE__ */ new WeakSet(), ma = function(t = false) {
  if (A(this, Qa, Id).call(this), !o(this, Si) || this.destroyed)
    return false;
  if (t)
    return w(this, dr, setTimeout(() => {
      w(this, dr, null), A(this, ur, ma).call(this, false);
    }, FL)), false;
  for (const {
    renderTasks: e,
    operatorList: n
...
}, Qa = /* @__PURE__ */ new WeakSet(), Id = function() {
...
var Xe = class Xe2 {
  constructor({
    ...
    if (this.name = t, this.destroyed = false, this.verbosity = n, this._readyCapability = Promise.withResolvers(), this._port = null, this._webWorker = null, this._messageHandler = null, e) {
      if ((i = o(Xe2, ps)) != null && i.has(e))
        throw new Error("Cannot use more than one PDFWorker per port.");
      (o(Xe2, ps) || w(Xe2, ps, /* @__PURE__ */ new WeakMap())).set(e, this), this._initializeFromPort(e);
      return;
    }
    this._initialize();
  }
  ...
  _initialize() {
    if (!ui.isWorkerDisabled && !o(Xe2, to, Fd)) {
      let {
        workerSrc: t
      } = Xe2;
      try {
  ...
  _setupFakeWorker() {
    ui.isWorkerDisabled || (yt("Setting up fake worker."), ui.isWorkerDisabled = true), Xe2._setupFakeWorkerGlobal.then((t) => {
      if (this.destroyed) {
  ...
  destroy() {
    var t;
    this.destroyed = true, this._webWorker && (this._webWorker.terminate(), this._webWorker = null), (t = o(Xe2, ps)) == null || t.delete(this._port), this._port = null, this._messageHandler && (this._messageHandler.destroy(), this._messageHandler = null);
  }
  static fromPort(t) {
    var n;
    if (!(t != null && t.port))
...
ps = /* @__PURE__ */ new WeakMap(), to = /* @__PURE__ */ new WeakSet(), Fd = function() {
  var t;
  try {
...
var VL = class {
  ...
  destroy() {
    ...
    this.destroyed = true, this.destroyCapability = Promise.withResolvers(), (n = o(this, Vn)) == null || n.reject(new Error("Worker was destroyed during onPassword callback"));
    const t = [];
  ...
  setupMessageHandler() {
    ...
    t.on("GetReader", (n, i) => {
      ...
      this._numPages = n.numPages, this._htmlForXfa = n.htmlForXfa, delete n.htmlForXfa, e._capability.resolve(new UL(n, this));
      ...
      switch (i) {
        case "Font":
          ...
          if ("error" in s) {
            const v = s.error;
            yt(`Error during font loading: ${v}`), this.commonObjs.resolve(n, v);
            break;
          }
      ...
      if (!l.objs.has(n)) {
        ...
        switch (s) {
          case "Image":
            l.objs.resolve(n, a), (a == null ? void 0 : a.dataLen) > mR && (l._maybeCleanupAfterRender = true);
            break;
          case "Pattern":
            l.objs.resolve(n, a);
            break;
  ...
  async startCleanup(t = false) {
    if (!this.destroyed) {
      ...
      this.commonObjs.clear(), t || this.fontLoader.clear(), o(this, xi).clear(), this.filterFactory.destroy(true), au.cleanup();
    }
  }
  cachedPageNumber(t) {
    if (!Fv(t))
...
xi = /* @__PURE__ */ new WeakMap(), zn = /* @__PURE__ */ new WeakMap(), eo = /* @__PURE__ */ new WeakMap(), no = /* @__PURE__ */ new WeakMap(), Vn = /* @__PURE__ */ new WeakMap(), gs = /* @__PURE__ */ new WeakSet(), fl = function(t, e = null) {
...
var Br = class Br2 {
  constructor({
    ...
    this.callback = t, this.params = e, this.objs = n, this.commonObjs = i, this.annotationCanvasMap = s, this.operatorListIdx = null, this.operatorList = a, this._pageIndex = l, this.canvasFactory = c, this.filterFactory = d, this._pdfBug = f, this.pageColors = g, this.running = false, this.graphicsReadyCallback = null, this.graphicsReady = false, this._useRequestAnimationFrame = h === true && typeof window < "u", this.cancelled = false, this.capability = Promise.withResolvers(), this.task = new GL(this), this._cancelBound = this.cancel.bind(this), this._continueBound = this._continue.bind(this), this._scheduleNextBound = this._scheduleNext.bind(this), this._nextBound = this._next.bind(this), this._canvas = e.canvasContext.canvas;
  }
  get completed() {
  ...
  initializeGraphics({
    ...
    if (this.cancelled)
      return;
    if (this._canvas) {
      if (o(Br2, ms).has(this._canvas))
        throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
      o(Br2, ms).add(this._canvas);
    }
  ...
  cancel(t = null, e = 0) {
    var n;
    this.running = false, this.cancelled = true, (n = this.gfx) == null || n.endDrawing(), o(Br2, ms).delete(this._canvas), this.callback(t || new f0(`Rendering cancelled, page ${this._pageIndex + 1}`, e));
  }
  operatorListChanged() {
    var t;
    ...
    switch (n.name) {
      ...
      case "input":
        if (n.attributes.type === "radio" || n.attributes.type === "checkbox") {
          if (a.value === n.attributes.xfaOn ? t.setAttribute("checked", true) : a.value === n.attributes.xfaOff && t.removeAttribute("checked"), s === "print")
            break;
      ...
      case "select":
        if (a.value !== null) {
          ...
          for (const l of n.children)
            l.attributes.value === a.value ? l.attributes.selected = true : l.attributes.hasOwnProperty("selected") && delete l.attributes.selected;
        }
        t.addEventListener("input", (l) => {
...
var P0 = class P02 {
  ...
  _createContainer(t) {
    ...
    if (!t && e.borderStyle.width > 0) {
      ...
      _ ? (w(this, io, true), a.borderColor = Q.makeHexColor(_[0] | 0, _[1] | 0, _[2] | 0)) : a.borderWidth = 0;
    }
    ...
    if (this._fieldObjects) {
      ...
      if (i)
        for (const {
          ...
          if (d && !na.has(d)) {
            yt(`_getElementsByName - element not allowed: ${a}`);
            continue;
          }
          n.push({
            id: a,
...
vs = /* @__PURE__ */ new WeakMap(), io = /* @__PURE__ */ new WeakMap(), ro = /* @__PURE__ */ new WeakMap(), $c = /* @__PURE__ */ new WeakSet(), am = function(t) {
  const {
    container: {
      style: e
    },
...
var gw = class extends Jt {
  ...
  _bindResetFormAction(e, n) {
    ...
    if (i || (e.href = this.linkService.getAnchorUrl("")), A(this, Ci, Fr).call(this), !this._fieldObjects) {
      yt('_bindResetFormAction - "resetForm" action not supported, ensure that the `fieldObjects` parameter is provided.'), i || (e.onclick = () => false);
      return;
    }
    e.onclick = () => {
      var f;
      ...
      for (const g of c) {
        ...
        if (y) {
          if (!na.has(y)) {
            yt(`_bindResetFormAction - element not allowed: ${v}`);
            continue;
          }
        } else
          continue;
...
`)) || null;
      ...
      this.data.multiLine ? (n = document.createElement("textarea"), n.textContent = d ?? l, this.data.doNotScroll && (n.style.overflowY = "hidden")) : (n = document.createElement("input"), n.type = "text", n.setAttribute("value", d ?? l), this.data.doNotScroll && (n.style.overflowX = "hidden")), this.data.hasOwnCanvas && (n.hidden = true), na.add(n), n.setAttribute("data-element-id", e), n.disabled = this.data.readOnly, n.name = this.data.fieldName, n.tabIndex = ed, this._setRequired(n, this.data.required), c && (n.maxLength = c), n.addEventListener("input", (g) => {
        t.setValue(e, {
...
var QL = class extends ca {
  ...
  render() {
    ...
    return na.add(s), s.setAttribute("data-element-id", n), s.disabled = e.readOnly, this._setRequired(s, this.data.required), s.type = "checkbox", s.name = e.fieldName, i && s.setAttribute("checked", true), s.setAttribute("exportValue", e.exportValue), s.tabIndex = ed, s.addEventListener("change", (a) => {
      const {
        name: l,
        checked: c
      } = a.target;
...
var yw = class extends ca {
  ...
  render() {
    ...
    const s = document.createElement("input");
    if (na.add(s), s.setAttribute("data-element-id", n), s.disabled = e.readOnly, this._setRequired(s, this.data.required), s.type = "radio", s.name = e.fieldName, i && s.setAttribute("checked", true), s.tabIndex = ed, s.addEventListener("change", (a) => {
      const {
        name: l,
        checked: c
      } = a.target;
...
var ek = class extends ca {
  ...
  render() {
    ...
    if (s) {
      ...
      h.value = " ", h.setAttribute("hidden", true), h.setAttribute("selected", true), i.prepend(h), a = () => {
...
var nk = class {
  constructor({
    ...
    m(this, As, false);
    var g;
    w(this, Yt, t), w(this, zc, i), w(this, Ti, a), w(this, Li, l), w(this, Uc, c), w(this, ys, e), w(this, jc, d), w(this, oo, h), w(this, Hc, n), w(this, bs, Tb.toDateObject(s)), this.trigger = n.flatMap((v) => v.getElementsToTriggerPopup());
    ...
    o(this, Yt).hidden = true, f && A(this, co, Dd).call(this);
  }
  render() {
    if (o(this, En))
      return;
  ...
  forceHide() {
    w(this, As, this.isVisible), o(this, As) && (o(this, Yt).hidden = true);
  }
  maybeShow() {
    o(this, As) && (o(this, En) || A(this, ho, Od).call(this), w(this, As, false), o(this, Yt).hidden = false);
  }
  get isVisible() {
    return o(this, Yt).hidden === false;
  }
};
so = /* @__PURE__ */ new WeakMap(), Qu = /* @__PURE__ */ new WeakMap(), tf = /* @__PURE__ */ new WeakMap(), ao = /* @__PURE__ */ new WeakMap(), ys = /* @__PURE__ */ new WeakMap(), Yt = /* @__PURE__ */ new WeakMap(), Ti = /* @__PURE__ */ new WeakMap(), bs = /* @__PURE__ */ new WeakMap(), Hc = /* @__PURE__ */ new WeakMap(), Uc = /* @__PURE__ */ new WeakMap(), oo = /* @__PURE__ */ new WeakMap(), Pi = /* @__PURE__ */ new WeakMap(), En = /* @__PURE__ */ new WeakMap(), Ri = /* @__PURE__ */ new WeakMap(), jc = /* @__PURE__ */ new WeakMap(), Li = /* @__PURE__ */ new WeakMap(), zc = /* @__PURE__ */ new WeakMap(), ws = /* @__PURE__ */ new WeakMap(), As = /* @__PURE__ */ new WeakMap(), lo = /* @__PURE__ */ new WeakSet(), Md = function() {
  const t = o(this, Li), e = o(this, Ti);
  return t != null && t.str && (!(e != null && e.str) || e.str === t.str) && o(this, Li).html || null;
}, Vc = /* @__PURE__ */ new WeakSet(), lm = function() {
  var t, e, n;
...
`))
  ...
  for (const y of o(this, Hc))
    if (!l || Q.intersect(y.data.rect, l) !== null) {
      l = y.data.rect, a = true;
      break;
    }
...
}, co = /* @__PURE__ */ new WeakSet(), Dd = function() {
...
}, ho = /* @__PURE__ */ new WeakSet(), Od = function() {
  o(this, En) || this.render(), this.isVisible ? o(this, Pi) && o(this, Yt).classList.add("focused") : (A(this, sf, Ew).call(this), o(this, Yt).hidden = false, o(this, Yt).style.zIndex = parseInt(o(this, Yt).style.zIndex) + 1e3);
}, Gc = /* @__PURE__ */ new WeakSet(), cm = function() {
  o(this, Yt).classList.remove("focused"), !(o(this, Pi) || !this.isVisible) && (o(this, Yt).hidden = true, o(this, Yt).style.zIndex = parseInt(o(this, Yt).style.zIndex) - 1e3);
};
...
var ik = class extends Jt {
  ...
  render() {
    ...
    const e = this.data, {
      width: n,
      height: i
    } = Vi(e.rect), s = this.svgFactory.create(n, i, true), a = w(this, Wc, this.svgFactory.createElement("svg:line"));
...
var rk = class extends Jt {
  ...
  render() {
    ...
    const e = this.data, {
      width: n,
      height: i
    } = Vi(e.rect), s = this.svgFactory.create(n, i, true), a = e.borderStyle.width, l = w(this, qc, this.svgFactory.createElement("svg:rect"));
...
var sk = class extends Jt {
  ...
  render() {
    ...
    const e = this.data, {
      width: n,
      height: i
    } = Vi(e.rect), s = this.svgFactory.create(n, i, true), a = e.borderStyle.width, l = w(this, Xc, this.svgFactory.createElement("svg:ellipse"));
...
var Sw = class extends Jt {
  ...
  render() {
    ...
    const e = this.data, {
      width: n,
      height: i
    } = Vi(e.rect), s = this.svgFactory.create(n, i, true);
    let a = [];
...
var ak = class extends Sw {
  constructor(t) {
    super(t), this.containerClassName = "polygonAnnotation", this.svgElementName = "svg:polygon";
  }
};
var ok = class extends Jt {
  constructor(t) {
    super(t, {
      isRenderable: true,
      ignoreBorder: true
...
}, Qc = /* @__PURE__ */ new WeakMap(), Es = /* @__PURE__ */ new WeakMap(), uo = /* @__PURE__ */ new WeakMap(), af = /* @__PURE__ */ new WeakSet(), Tw = function(t, e) {
  var i;
  const n = t.firstChild || t;
  n.id = `${Eb}${e}`, this.div.append(t), (i = o(this, Qc)) == null || i.moveElementInDOM(this.div, t, n, false);
...
var Bt = class Bt2 extends Ft {
  ...
  static get _keyboardManager() {
    const e = Bt2.prototype, n = (a) => a.isEmpty(), i = ea.TRANSLATE_SMALL, s = ea.TRANSLATE_BIG;
  ...
  static get defaultPropertiesToUpdate() {
    return [[ot.FREETEXT_SIZE, Bt2._defaultFontSize], [ot.FREETEXT_COLOR, Bt2._defaultColor || Ft._defaultLineColor]];
  }
  get propertiesToUpdate() {
  ...
  getInitialTranslation() {
    ...
    return [-Bt2._internalPadding * e, -(Bt2._internalPadding + o(this, Ze)) * e];
  }
  rebuild() {
  ...
  disableEditMode() {
    this.isInEditMode() && (this.parent.setEditingState(true), super.disableEditMode(), this.overlayDiv.classList.add("enabled"), this.editorDiv.contentEditable = false, this.div.setAttribute("aria-activedescendant", o(this, ah)), this._isDraggable = true, this.editorDiv.removeEventListener("keydown", o(this, rh)), this.editorDiv.removeEventListener("focus", o(this, nh)), this.editorDiv.removeEventListener("blur", o(this, eh)), this.editorDiv.removeEventListener("input", o(this, ih)), this.editorDiv.removeEventListener("paste", o(this, sh)), this.div.focus({
      preventScroll: true
  ...
  render() {
    ...
    if (i.fontSize = `calc(${o(this, Ze)}px * var(--scale-factor))`, i.color = o(this, _n), this.div.append(this.editorDiv), this.overlayDiv = document.createElement("div"), this.overlayDiv.classList.add("overlay", "enabled"), this.div.append(this.overlayDiv), iu(this, this.div, ["dblclick", "keydown"]), this.width) {
      ...
      A(this, mo, $d).call(this), this._isDraggable = true, this.editorDiv.contentEditable = false;
    } else
  ...
  editorDivPaste(e) {
    ...
    if (i.length === 1 && i[0] === "text/plain")
      return;
    e.preventDefault();
    const s = A(y = Bt2, oh, fm).call(y, n.getData("text") || "").replaceAll(gd, `
`);
    if (!s)
      return;
...
`)) {
    ...
    if (c.nodeType === Node.TEXT_NODE) {
      ...
      let _ = h, P = 0;
      for (const L of this.editorDiv.childNodes)
        P++ === d && (_ = f), _.push(A(x = Bt2, go, Bd).call(x, L));
    }
    w(this, Ke, `${h.join(`
`)}${s}${f.join(`
...
`),
    ...
    return w(a, Ze, e.fontSize), w(a, _n, Q.makeHexColor(...e.color)), w(a, Ke, A(l = Bt2, oh, fm).call(l, e.value)), a.annotationElementId = e.id || null, w(a, fo, s), a;
  }
  serialize(e = false) {
    if (this.isEmpty())
      return null;
    ...
    const n = Bt2._internalPadding * this.parentScale, i = this.getRect(n, n), s = Ft._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : o(this, _n)), a = {
      annotationType: _t.FREETEXT,
      color: s,
      fontSize: o(this, Ze),
...
eh = /* @__PURE__ */ new WeakMap(), nh = /* @__PURE__ */ new WeakMap(), ih = /* @__PURE__ */ new WeakMap(), rh = /* @__PURE__ */ new WeakMap(), sh = /* @__PURE__ */ new WeakMap(), _n = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), ah = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakMap(), fo = /* @__PURE__ */ new WeakMap(), of = /* @__PURE__ */ new WeakSet(), Pw = function(e) {
  const n = (s) => {
...
}, cf = /* @__PURE__ */ new WeakSet(), Lw = function() {
  var n;
  const e = [];
  ...
  return e.join(`
`);
}, po = /* @__PURE__ */ new WeakSet(), Nd = function() {
...
}, go = /* @__PURE__ */ new WeakSet(), Bd = function(e) {
  return (e.nodeType === Node.TEXT_NODE ? e.nodeValue : e.innerText).replaceAll(gd, "");
}, mo = /* @__PURE__ */ new WeakSet(), $d = function() {
...
}, hf = /* @__PURE__ */ new WeakSet(), kw = function() {
  return o(this, Ke).replaceAll(" ", " ");
}, oh = /* @__PURE__ */ new WeakSet(), fm = function(e) {
  return e.replaceAll(" ", " ");
...
}, m(Bt, go), m(Bt, oh), dt(Bt, "_freeTextDefaultContent", ""), dt(Bt, "_internalPadding", 0), dt(Bt, "_defaultColor", null), dt(Bt, "_defaultFontSize", 10), dt(Bt, "_type", "freetext"), dt(Bt, "_editorType", _t.FREETEXT);
var um = Bt;
var lh;
var pr;
var Sn;
...
var pm = class {
  constructor(t, e = 0, n = 0, i = true) {
    ...
    for (const {
      ...
      const F = Math.floor((_ - e) / h) * h, I = Math.ceil((_ + L + e) / h) * h, M = Math.floor((P - e) / h) * h, C = Math.ceil((P + k + e) / h) * h, T = [F, M, C, true], O = [I, M, C, false];
...
lh = /* @__PURE__ */ new WeakMap(), pr = /* @__PURE__ */ new WeakMap(), Sn = /* @__PURE__ */ new WeakMap(), uf = /* @__PURE__ */ new WeakSet(), Fw = function(t) {
...
}, vo = /* @__PURE__ */ new WeakSet(), Hd = function(t) {
  const e = o(this, Sn);
  ...
  const n = A(this, vo, Hd).call(this, t);
  ...
  const [e, n, i] = t, s = [[e, n, i]], a = A(this, vo, Hd).call(this, i);
  for (let l = 0; l < a; l++) {
...
hh = /* @__PURE__ */ new WeakMap(), yo = /* @__PURE__ */ new WeakMap();
var Gn;
var ki;
var bo;
var wo;
...
var hi = class hi2 {
  constructor({
    ...
    m(this, Eo, void 0);
    m(this, gr, []);
    w(this, Gn, n), w(this, Eo, s * i), w(this, wo, a), o(this, Et).set([NaN, NaN, NaN, NaN, t, e], 6), w(this, bo, l), w(this, uh, o(hi2, fh) * i), w(this, dh, o(hi2, mf) * i), w(this, Ao, i), o(this, gr).push(t, e);
  }
  get free() {
    return true;
  }
...
Gn = /* @__PURE__ */ new WeakMap(), ki = /* @__PURE__ */ new WeakMap(), bo = /* @__PURE__ */ new WeakMap(), wo = /* @__PURE__ */ new WeakMap(), Wn = /* @__PURE__ */ new WeakMap(), Et = /* @__PURE__ */ new WeakMap(), _s = /* @__PURE__ */ new WeakMap(), Ss = /* @__PURE__ */ new WeakMap(), dh = /* @__PURE__ */ new WeakMap(), uh = /* @__PURE__ */ new WeakMap(), Ao = /* @__PURE__ */ new WeakMap(), Eo = /* @__PURE__ */ new WeakMap(), gr = /* @__PURE__ */ new WeakMap(), fh = /* @__PURE__ */ new WeakMap(), gf = /* @__PURE__ */ new WeakMap(), mf = /* @__PURE__ */ new WeakMap(), ph = /* @__PURE__ */ new WeakSet(), mm = function() {
...
_o = /* @__PURE__ */ new WeakMap(), xs = /* @__PURE__ */ new WeakMap(), Ii = /* @__PURE__ */ new WeakMap(), gh = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakMap(), mh = /* @__PURE__ */ new WeakMap(), Zt = /* @__PURE__ */ new WeakMap(), Cs = /* @__PURE__ */ new WeakSet(), pl = function(e, n, i, s, a) {
  const l = new Float64Array(e.length);
  for (let c = 0, d = e.length; c < d; c += 2)
    l[c] = n + e[c] * s, l[c + 1] = i + e[c + 1] * a;
  return l;
}, Ts = /* @__PURE__ */ new WeakSet(), gl = function(e, n, i, s, a) {
  const l = new Float64Array(e.length);
  for (let c = 0, d = e.length; c < d; c += 2)
...
var di = class di2 {
  constructor({
    ...
    m(this, Co, void 0);
    var n;
    t ? (w(this, xo, false), w(this, Co, ot.HIGHLIGHT_COLOR), w(this, wh, t)) : (w(this, xo, true), w(this, Co, ot.HIGHLIGHT_DEFAULT_COLOR)), w(this, mr, (t == null ? void 0 : t._uiManager) || e), w(this, Ah, o(this, mr)._eventBus), w(this, So, (t == null ? void 0 : t.color) || ((n = o(this, mr)) == null ? void 0 : n.highlightColors.values().next().value) || "#FFFF98");
  }
  static get _keyboardManager() {
  ...
  renderButton() {
    ...
    t.className = "colorPicker", t.tabIndex = "0", t.setAttribute("data-l10n-id", "pdfjs-editor-colorpicker-button"), t.setAttribute("aria-haspopup", true), t.addEventListener("click", A(this, Fi, Mr).bind(this)), t.addEventListener("keydown", o(this, vh));
    const e = w(this, Ps, document.createElement("span"));
    return e.className = "swatch", e.setAttribute("aria-hidden", true), e.style.backgroundColor = o(this, So), t.append(e), t;
  }
  renderMainDropdown() {
...
vh = /* @__PURE__ */ new WeakMap(), yh = /* @__PURE__ */ new WeakMap(), xn = /* @__PURE__ */ new WeakMap(), Ps = /* @__PURE__ */ new WeakMap(), So = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakMap(), bh = /* @__PURE__ */ new WeakMap(), xo = /* @__PURE__ */ new WeakMap(), wh = /* @__PURE__ */ new WeakMap(), Ah = /* @__PURE__ */ new WeakMap(), mr = /* @__PURE__ */ new WeakMap(), Co = /* @__PURE__ */ new WeakMap(), Eh = /* @__PURE__ */ new WeakSet(), ym = function() {
  const t = document.createElement("div");
  t.addEventListener("contextmenu", Ge), t.className = "dropdown", t.role = "listbox", t.setAttribute("aria-multiselectable", false), t.setAttribute("aria-orientation", "vertical"), t.setAttribute("data-l10n-id", "pdfjs-editor-colorpicker-dropdown");
...
var Ct = class Ct2 extends Ft {
  constructor(e) {
    ...
    m(this, Xn, void 0);
    m(this, Th, "");
    this.color = e.color || Ct2._defaultColor, w(this, Xn, e.thickness || Ct2._defaultThickness), w(this, ks, e.opacity || Ct2._defaultOpacity), w(this, vr, e.boxes || null), w(this, Th, e.methodOfCreation || ""), w(this, Lo, e.text || ""), this._isDraggable = false, e.highlightId > -1 ? (w(this, Qe, true), A(this, Rh, Am).call(this, e), A(this, Is, ml).call(this)) : (w(this, To, e.anchorNode), w(this, Sh, e.anchorOffset), w(this, xh, e.focusNode), w(this, Ch, e.focusOffset), A(this, Ph, wm).call(this), A(this, Is, ml).call(this), this.rotate(this.rotation));
  }
  static get _keyboardManager() {
  ...
  updateParams(e, n) {
    switch (e) {
      case ot.HIGHLIGHT_COLOR:
        A(this, Af, Hw).call(this, n);
        break;
      case ot.HIGHLIGHT_THICKNESS:
        A(this, Ef, Uw).call(this, n);
        break;
    }
  }
  static get defaultPropertiesToUpdate() {
    return [[ot.HIGHLIGHT_DEFAULT_COLOR, Ct2._defaultColor], [ot.HIGHLIGHT_THICKNESS, Ct2._defaultThickness]];
  }
  get propertiesToUpdate() {
    return [[ot.HIGHLIGHT_COLOR, this.color || Ct2._defaultColor], [ot.HIGHLIGHT_THICKNESS, o(this, Xn) || Ct2._defaultThickness], [ot.HIGHLIGHT_FREE, o(this, Qe)]];
  }
  async addEditToolbar() {
  ...
  rotate(e) {
    ...
    let i;
    o(this, Qe) ? (e = (e - this.rotation + 360) % 360, i = A(s = Ct2, yr, va).call(s, o(this, Cn).box, e)) : i = A(a = Ct2, yr, va).call(a, this, e), n.rotate(o(this, Fe), e), n.rotate(o(this, se), e), n.updateBox(o(this, Fe), i), n.updateBox(o(this, se), A(l = Ct2, yr, va).call(l, o(this, hn).box, e));
  }
  render() {
    if (this.div)
      return this.div;
  ...
  _moveCaret(e) {
    switch (this.parent.unselect(this), e) {
      case 0:
      case 2:
        A(this, ko, Ud).call(this, true);
        break;
      case 1:
      case 3:
        A(this, ko, Ud).call(this, false);
        break;
    }
  }
  select() {
  ...
  unselect() {
    var e;
    super.unselect(), o(this, se) && ((e = this.parent) == null || e.drawLayer.removeClass(o(this, se), "selected"), o(this, Qe) || A(this, ko, Ud).call(this, false));
  }
  get _mustFixPosition() {
    return !o(this, Qe);
  }
...
To = /* @__PURE__ */ new WeakMap(), Sh = /* @__PURE__ */ new WeakMap(), vr = /* @__PURE__ */ new WeakMap(), Rs = /* @__PURE__ */ new WeakMap(), Po = /* @__PURE__ */ new WeakMap(), hn = /* @__PURE__ */ new WeakMap(), xh = /* @__PURE__ */ new WeakMap(), Ch = /* @__PURE__ */ new WeakMap(), Ls = /* @__PURE__ */ new WeakMap(), Cn = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), Qe = /* @__PURE__ */ new WeakMap(), wf = /* @__PURE__ */ new WeakMap(), Ro = /* @__PURE__ */ new WeakMap(), ks = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Lo = /* @__PURE__ */ new WeakMap(), Xn = /* @__PURE__ */ new WeakMap(), Th = /* @__PURE__ */ new WeakMap(), Ph = /* @__PURE__ */ new WeakSet(), wm = function() {
...
}, Af = /* @__PURE__ */ new WeakSet(), Hw = function(e) {
  const n = (s) => {
    var a, l;
...
}, Ef = /* @__PURE__ */ new WeakSet(), Uw = function(e) {
...
}, Lh = /* @__PURE__ */ new WeakSet(), Em = function() {
...
}, yr = /* @__PURE__ */ new WeakSet(), va = function({
  x: e,
  y: n,
  width: i,
  height: s
...
}, ko = /* @__PURE__ */ new WeakSet(), Ud = function(e) {
  if (!o(this, To))
    return;
...
}, xf = /* @__PURE__ */ new WeakSet(), Vw = function() {
  if (o(this, Qe))
    return null;
  ...
  return s;
}, Cf = /* @__PURE__ */ new WeakSet(), Gw = function(e) {
...
}, m(Ct, yr), m(Ct, Tf), m(Ct, Pf), dt(Ct, "_defaultColor", null), dt(Ct, "_defaultOpacity", 1), dt(Ct, "_defaultThickness", 12), dt(Ct, "_l10nPromise"), dt(Ct, "_type", "highlight"), dt(Ct, "_editorType", _t.HIGHLIGHT), dt(Ct, "_freeHighlightId", -1), dt(Ct, "_freeHighlight", null), dt(Ct, "_freeHighlightClipId", "");
var cu = Ct;
var Ms;
var Ds;
var kh;
...
var jt = class jt2 extends Ft {
  ...
  static get defaultPropertiesToUpdate() {
    return [[ot.INK_THICKNESS, jt2._defaultThickness], [ot.INK_COLOR, jt2._defaultColor || Ft._defaultLineColor], [ot.INK_OPACITY, Math.round(jt2._defaultOpacity * 100)]];
  }
  get propertiesToUpdate() {
    return [[ot.INK_THICKNESS, this.thickness || jt2._defaultThickness], [ot.INK_COLOR, this.color || jt2._defaultColor || Ft._defaultLineColor], [ot.INK_OPACITY, Math.round(100 * (this.opacity ?? jt2._defaultOpacity))]];
  }
  rebuild() {
  ...
  enableEditMode() {
    o(this, dn) || this.canvas === null || (super.enableEditMode(), this._isDraggable = false, this.canvas.addEventListener("pointerdown", o(this, Os)));
  }
  disableEditMode() {
  ...
  commit() {
    o(this, dn) || (super.commit(), this.isEditing = false, this.disableEditMode(), this.setInForeground(), w(this, dn, true), this.div.classList.add("disabled"), A(this, js, yl).call(this, true), this.select(), this.parent.addInkEditorIfNeeded(true), this.moveInDOM(), this.div.focus({
      preventScroll: true
    }));
  }
  focusin(e) {
  ...
  render() {
    ...
    if (this.setAt(i, s, 0, 0), this.setDims(a, l), A(this, Io, jd).call(this), this.width) {
      ...
      this.setAspectRatio(this.width * c, this.height * d), this.setAt(e * c, n * d, this.width * c, this.height * d), w(this, Bs, true), A(this, wr, ya).call(this), this.setDims(this.width * c, this.height * d), A(this, Di, Dr).call(this), this.div.classList.add("disabled");
    } else
  ...
  setDimensions(e, n) {
    ...
    if (o(this, Hs) === i && o(this, Us) === s)
      return;
    w(this, Hs, i), w(this, Us, s), this.canvas.style.visibility = "hidden";
    const [a, l] = this.parentDimensions;
  ...
  static deserialize(e, n, i) {
    ...
    w(s, dn, true), w(s, Hs, Math.round(c)), w(s, Us, Math.round(d));
    const {
      paths: g,
      rect: v,
      rotation: y
    ...
    for (let {
      ...
      L = A(x = jt2, Hf, s1).call(x, L, v, y);
      const k = [];
      s.paths.push(k);
      let F = h * (L[0] - f), I = h * (L[1] - f);
      for (let C = 2, T = L.length; C < T; C += 6) {
        const O = h * (L[C] - f), D = h * (L[C + 1] - f), U = h * (L[C + 2] - f), j = h * (L[C + 3] - f), V = h * (L[C + 4] - f), Y = h * (L[C + 5] - f);
        k.push([[F, I], [O, D], [U, j], [V, Y]]), F = V, I = Y;
      }
  ...
  serialize() {
    ...
    return {
      ...
      paths: A(this, Uf, a1).call(this, this.scaleFactor / this.parentScale, this.translationX, this.translationY, e),
      pageIndex: this.pageIndex,
      rect: e,
      rotation: this.rotation,
      structTreeParentId: this._structTreeParentId
...
Ms = /* @__PURE__ */ new WeakMap(), Ds = /* @__PURE__ */ new WeakMap(), kh = /* @__PURE__ */ new WeakMap(), Ih = /* @__PURE__ */ new WeakMap(), Fh = /* @__PURE__ */ new WeakMap(), Os = /* @__PURE__ */ new WeakMap(), Yn = /* @__PURE__ */ new WeakMap(), Mi = /* @__PURE__ */ new WeakMap(), dn = /* @__PURE__ */ new WeakMap(), Ns = /* @__PURE__ */ new WeakMap(), Bs = /* @__PURE__ */ new WeakMap(), $s = /* @__PURE__ */ new WeakMap(), Hs = /* @__PURE__ */ new WeakMap(), Us = /* @__PURE__ */ new WeakMap(), br = /* @__PURE__ */ new WeakMap(), Rf = /* @__PURE__ */ new WeakSet(), Xw = function(e) {
  const n = (s) => {
...
}, Lf = /* @__PURE__ */ new WeakSet(), Yw = function(e) {
  const n = (s) => {
...
}, kf = /* @__PURE__ */ new WeakSet(), Kw = function(e) {
  const n = (s) => {
  ...
  this.canvas.addEventListener("contextmenu", Ge), this.canvas.addEventListener("pointerleave", o(this, Ih)), this.canvas.addEventListener("pointermove", o(this, kh)), this.canvas.addEventListener("pointerup", o(this, Fh)), this.canvas.removeEventListener("pointerdown", o(this, Os)), this.isEditing = true, o(this, Bs) || (w(this, Bs, true), A(this, wr, ya).call(this), this.thickness || (this.thickness = jt._defaultThickness), this.color || (this.color = jt._defaultColor || Ft._defaultLineColor), this.opacity ?? (this.opacity = jt._defaultOpacity)), this.currentPath.push([e, n]), w(this, Ns, false), A(this, Mh, Sm).call(this), w(this, br, () => {
  ...
  let l = o(this, Mi);
  if (a.push([e, n]), w(this, Ns, true), a.length <= 2) {
...
}, Nf = /* @__PURE__ */ new WeakSet(), n1 = function(e, n, i, s, a, l, c) {
...
}, Io = /* @__PURE__ */ new WeakSet(), jd = function() {
...
}, Fo = /* @__PURE__ */ new WeakSet(), zd = function() {
...
}, wr = /* @__PURE__ */ new WeakSet(), ya = function() {
  if (!o(this, Bs))
    return;
  const [e, n] = this.parentDimensions;
  ...
  return e;
}, Hf = /* @__PURE__ */ new WeakSet(), s1 = function(e, n, i) {
  const [s, a, l, c] = n;
  switch (i) {
    case 0:
      for (let d = 0, h = e.length; d < h; d += 2)
  ...
  return e;
}, Uf = /* @__PURE__ */ new WeakSet(), a1 = function(e, n, i, s) {
  var h, f;
  ...
  for (const g of this.paths) {
    ...
    for (let E = 0, x = g.length; E < x; E++) {
      ...
      const F = e * _[0] + c, I = e * _[1] + d, M = e * P[0] + c, C = e * P[1] + d, T = e * L[0] + c, O = e * L[1] + d, D = e * k[0] + c, U = e * k[1] + d;
      E === 0 && (v.push(F, I), y.push(F, I)), v.push(M, C, T, O, D, U), y.push(M, C), E === x - 1 && y.push(D, U);
    }
    a.push({
  ...
  return [e, i, n, s];
}, Do = /* @__PURE__ */ new WeakSet(), Gd = function() {
  ...
  this.translationX = -n[0], this.translationY = -n[1], A(this, wr, ya).call(this), A(this, Di, Dr).call(this), w(this, Hs, s), w(this, Us, a), this.setDims(s, a);
  const f = e ? i / this.scaleFactor / 2 : 0;
  this.translate(d - this.translationX - f, h - this.translationY - f);
}, m(jt, $f), m(jt, Bh), m(jt, Hf), dt(jt, "_defaultColor", null), dt(jt, "_defaultOpacity", 1), dt(jt, "_defaultThickness", 1), dt(jt, "_type", "ink"), dt(jt, "_editorType", _t.INK);
var _m = jt;
var Ae;
var Ee;
var Ar;
...
var Sl = class Sl2 extends Ft {
  ...
  render() {
    if (this.div)
      return this.div;
    let e, n;
    if (this.width && (e = this.x, n = this.y), super.render(), this.div.hidden = true, this.addAltTextButton(), o(this, Ae) ? A(this, Uh, km).call(this) : A(this, No, Wd).call(this), this.width) {
      const [i, s] = this.parentDimensions;
  ...
  serialize(e = false, n = null) {
    ...
    if (e)
      return i.bitmapUrl = A(this, Bo, qd).call(this, true), i.accessibilityData = this.altTextData, i;
    const {
      decorative: s,
      altText: a
    } = this.altTextData;
    ...
    if (!n.stamps.has(o(this, Ee)))
      n.stamps.set(o(this, Ee), {
        area: l,
        serialized: i
      }), i.bitmap = A(this, Bo, qd).call(this, false);
    else if (o(this, Tn)) {
      const c = n.stamps.get(o(this, Ee));
      l > c.area && (c.area = l, c.serialized.bitmap.close(), c.serialized.bitmap = A(this, Bo, qd).call(this, false));
    }
    return i;
  }
};
Ae = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), Ar = /* @__PURE__ */ new WeakMap(), Oi = /* @__PURE__ */ new WeakMap(), Er = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), Kn = /* @__PURE__ */ new WeakMap(), zs = /* @__PURE__ */ new WeakMap(), Zn = /* @__PURE__ */ new WeakMap(), Tn = /* @__PURE__ */ new WeakMap(), Hh = /* @__PURE__ */ new WeakMap(), Vs = /* @__PURE__ */ new WeakSet(), bl = function(e, n = false) {
  if (!e) {
    this.remove();
    return;
  }
  w(this, Ae, e.bitmap), n || (w(this, Ee, e.id), w(this, Tn, e.isSvg)), e.file && w(this, Oo, e.file.name), A(this, Uh, km).call(this);
}, Gs = /* @__PURE__ */ new WeakSet(), wl = function() {
  w(this, Ar, null), this._uiManager.enableWaiting(false), o(this, Kn) && this.div.focus();
}, No = /* @__PURE__ */ new WeakSet(), Wd = function() {
  if (o(this, Ee)) {
    this._uiManager.enableWaiting(true), this._uiManager.imageManager.getFromId(o(this, Ee)).then((n) => A(this, Vs, bl).call(this, n, true)).finally(() => A(this, Gs, wl).call(this));
    return;
  }
  if (o(this, Oi)) {
    const n = o(this, Oi);
    w(this, Oi, null), this._uiManager.enableWaiting(true), w(this, Ar, this._uiManager.imageManager.getFromUrl(n).then((i) => A(this, Vs, bl).call(this, i)).finally(() => A(this, Gs, wl).call(this)));
    return;
  }
  if (o(this, Er)) {
    const n = o(this, Er);
    w(this, Er, null), this._uiManager.enableWaiting(true), w(this, Ar, this._uiManager.imageManager.getFromFile(n).then((i) => A(this, Vs, bl).call(this, i)).finally(() => A(this, Gs, wl).call(this)));
    return;
  }
...
}, Uh = /* @__PURE__ */ new WeakSet(), km = function() {
  const {
    div: e
  } = this;
  let {
  ...
  const [c, d] = this.parentDimensions;
  this.setDims(n * c / s, i * d / a), this._uiManager.enableWaiting(false);
  const h = w(this, Kn, document.createElement("canvas"));
  e.append(h), e.hidden = false, A(this, jh, Im).call(this, n, i), A(this, Vf, c1).call(this), o(this, Hh) || (this.parent.addUndoableEditor(this), w(this, Hh, true)), this._reportTelemetry({
    action: "inserted_image"
  }), o(this, Oo) && h.setAttribute("aria-label", o(this, Oo));
}, jf = /* @__PURE__ */ new WeakSet(), o1 = function(e, n) {
  var l;
  const [i, s] = this.parentDimensions;
...
}, Bo = /* @__PURE__ */ new WeakSet(), qd = function(e) {
  if (e) {
    if (o(this, Tn)) {
...
var gn = class gn2 {
  ...
  get isInvisible() {
    return this.isEmpty && o(this, it).getMode() === _t.NONE;
  }
  updateToolbar(t) {
  ...
  updateMode(t = o(this, it).getMode()) {
    ...
    for (const n of o(gn2, Sr).values())
  ...
  enable() {
    ...
    for (const n of o(this, tn).values())
      n.enableEditing(), n.show(true), n.annotationElementId && (o(this, it).removeChangedExistingAnnotation(n), t.add(n.annotationElementId));
    if (!o(this, Jn))
      return;
  ...
  disable() {
    var i;
    w(this, Uo, true), this.div.tabIndex = -1, this.togglePointerEvents(false);
    ...
    if (o(this, Jn)) {
      ...
      for (const a of s) {
        ...
        let c = e.get(l);
        if (c) {
          c.resetAnnotationElement(a), c.show(false), a.show();
          continue;
        }
        c = t.get(l), c && (o(this, it).addChangedExistingAnnotation(c), c.renderAnnotationElement(a), c.show(false)), a.show();
      }
    }
    A(this, jo, Xd).call(this), this.isEmpty && (this.div.hidden = true);
    const {
      classList: n
    } = this.div;
    for (const s of o(gn2, Sr).values())
      n.remove(`${s._type}Editing`);
    this.disableTextSelection(), this.toggleAnnotationLayerPointerEvents(true), w(this, Uo, false);
  }
  getEditableAnnotation(t) {
    var e;
  ...
  detach(t) {
    var e;
    o(this, tn).delete(t.id), (e = o(this, Ws)) == null || e.removePointerInTextLayer(t.contentDiv), !o(this, Uo) && t.annotationElementId && o(this, it).addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t), o(this, it).removeEditor(t), t.div.remove(), t.isAttachedToDOM = false, o(this, Ho) || this.addInkEditorIfNeeded(false);
  }
  changeParent(t) {
    var e;
  ...
  moveEditorInDOM(t) {
    ...
    t.div.contains(e) && !o(this, $i) && (t._focusEventsAllowed = false, w(this, $i, setTimeout(() => {
      w(this, $i, null), t.div.contains(document.activeElement) ? t._focusEventsAllowed = true : (t.div.addEventListener("focusin", () => {
        t._focusEventsAllowed = true;
      }, {
        once: true
      }), e.focus());
    }, 0))), t._structTreeParentId = (n = o(this, Ws)) == null ? void 0 : n.moveElementInDOM(this.div, t.div, t.contentDiv, true);
  }
  addOrRebuild(t) {
  ...
  deserialize(t) {
    var e;
    return ((e = o(gn2, Sr).get(t.annotationType ?? t.annotationEditorType)) == null ? void 0 : e.deserialize(t, this, o(this, it))) || null;
  }
  ...
  addNewEditor() {
    this.createAndAddNewEditor(A(this, Gh, Om).call(this), true);
  }
  setSelected(t) {
  ...
  pointerup(t) {
    ...
    if (!(t.button !== 0 || t.ctrlKey && e) && t.target === this.div && o(this, _r)) {
      if (w(this, _r, false), !o(this, $o)) {
        w(this, $o, true);
        return;
      }
      if (o(this, it).getMode() === _t.STAMP) {
  ...
  pointerdown(t) {
    if (o(this, it).getMode() === _t.HIGHLIGHT && this.enableTextSelection(), o(this, _r)) {
      w(this, _r, false);
      return;
    }
    const {
  ...
  destroy() {
    ...
    for (const n of o(this, tn).values())
      (e = o(this, Ws)) == null || e.removePointerInTextLayer(n.contentDiv), n.setParent(null), n.isAttachedToDOM = false, n.div.remove();
...
Ws = /* @__PURE__ */ new WeakMap(), $o = /* @__PURE__ */ new WeakMap(), Jn = /* @__PURE__ */ new WeakMap(), qs = /* @__PURE__ */ new WeakMap(), Ni = /* @__PURE__ */ new WeakMap(), Bi = /* @__PURE__ */ new WeakMap(), $i = /* @__PURE__ */ new WeakMap(), tn = /* @__PURE__ */ new WeakMap(), _r = /* @__PURE__ */ new WeakMap(), Ho = /* @__PURE__ */ new WeakMap(), Uo = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), it = /* @__PURE__ */ new WeakMap(), Sr = /* @__PURE__ */ new WeakMap(), Gf = /* @__PURE__ */ new WeakSet(), h1 = function(t) {
  if (o(this, it).unselectAll(), t.target === o(this, Me).div) {
    ...
    if (t.button !== 0 || t.ctrlKey && e)
      return;
    o(this, it).showAllEditors("highlight", true, true), o(this, Me).div.classList.add("free"), cu.startHighlighting(this, o(this, it).direction === "ltr", t), o(this, Me).div.addEventListener("pointerup", () => {
...
}, Vh = /* @__PURE__ */ new WeakSet(), Dm = function(t) {
  const e = o(this, zh, Mm);
  return e ? new e.prototype.constructor(t) : null;
}, Gh = /* @__PURE__ */ new WeakSet(), Om = function() {
  const {
    x: t,
    y: e,
    width: n,
...
}, jo = /* @__PURE__ */ new WeakSet(), Xd = function() {
  w(this, Ho, true);
  for (const t of o(this, tn).values())
    t.isEmpty() && t.remove();
  w(this, Ho, false);
}, dt(gn, "_initialized", false), m(gn, Sr, new Map([um, _m, Lm, cu].map((t) => [t._editorType, t])));
var Fm = gn;
var Qn;
var Wh;
var ae;
...
var ge = class ge2 {
  ...
  updateBox(t, e) {
    var n;
    A(n = ge2, qh, Bm).call(n, o(this, ae).get(t), e);
  }
  show(t, e) {
...
Qn = /* @__PURE__ */ new WeakMap(), Wh = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), xr = /* @__PURE__ */ new WeakMap(), qh = /* @__PURE__ */ new WeakSet(), Bm = function(t, {
  x: e = 0,
  y: n = 0,
  width: i = 1,
  height: s = 1
  ...
  return o(this, Qn).append(e), e.setAttribute("aria-hidden", true), A(n = ge, qh, Bm).call(n, e, t), e;
...
var Nm = ge;
var gk = rt.AbortException;
var mk = rt.AnnotationEditorLayer;
var vk = rt.AnnotationEditorParamsType;
var yk = rt.AnnotationEditorType;
var bk = rt.AnnotationEditorUIManager;
var u1 = rt.AnnotationLayer;
var f1 = rt.AnnotationMode;
var wk = rt.CMapCompressionType;
var Ak = rt.ColorPicker;
var Ek = rt.DOMSVGFactory;
var _k = rt.DrawLayer;
var Sk = rt.FeatureTest;
var w0 = rt.GlobalWorkerOptions;
var xk = rt.ImageKind;
var Ck = rt.InvalidPDFException;
var Tk = rt.MissingPDFException;
var Pk = rt.OPS;
var Rk = rt.Outliner;
var Lk = rt.PDFDataRangeTransport;
var kk = rt.PDFDateString;
var Ik = rt.PDFWorker;
var Fk = rt.PasswordResponses;
var Mk = rt.PermissionFlag;
var Dk = rt.PixelsPerInch;
var Ok = rt.RenderingCancelledException;
var p1 = rt.TextLayer;
var Nk = rt.UnexpectedResponseException;
var Bk = rt.Util;
var $k = rt.VerbosityLevel;
var Hk = rt.XfaLayer;
var Uk = rt.build;
var jk = rt.createValidAbsoluteUrl;
var zk = rt.fetchData;
var g1 = rt.getDocument;
var Vk = rt.getFilenameFromUrl;
var Gk = rt.getPdfFilenameFromUrl;
var Wk = rt.getXfaPageViewport;
var qk = rt.isDataScheme;
var Xk = rt.isPdfFile;
var Yk = rt.noContextMenu;
var Kk = rt.normalizeUnicode;
var Zk = rt.renderTextLayer;
var Jk = rt.setLayerDimensions;
var Qk = rt.shadow;
var tI = rt.updateTextLayer;
var m1 = rt.version;
...
var nI = ["onCopy", "onCut", "onPaste"];
var iI = [
  "onCompositionEnd",
  "onCompositionStart",
  "onCompositionUpdate"
];
var rI = ["onFocus", "onBlur"];
var sI = ["onInput", "onInvalid", "onReset", "onSubmit"];
var aI = ["onLoad", "onError"];
var oI = ["onKeyDown", "onKeyPress", "onKeyUp"];
var lI = [
  "onAbort",
  "onCanPlay",
  "onCanPlayThrough",
...
var dI = ["onSelect"];
var uI = ["onTouchCancel", "onTouchEnd", "onTouchMove", "onTouchStart"];
var fI = [
  "onPointerDown",
  "onPointerMove",
  "onPointerUp",
...
var vI = ["onTransitionEnd"];
var yI = ["onToggle"];
var bI = ["onChange"];
var wI = he(he(he(he(he(he(he(he(he(he(he(he(he(he(he(he(he(he([], nI, true), iI, true), rI, true), sI, true), aI, true), oI, true), lI, true), cI, true), hI, true), dI, true), uI, true), fI, true), pI, true), gI, true), mI, true), vI, true), bI, true), yI, true);
function v1(r, t) {
  var e = {};
...
var AI = ct.env.NODE_ENV === "production";
...
var EI = ct.env.NODE_ENV !== "production";
var b1 = function() {
};
if (EI) {
  _I = function(t, e) {
...
var xI = "noopener noreferrer nofollow";
var CI = class {
  constructor() {
...
function Ko() {
  return (0, import_react.useReducer)(DI, { value: void 0, error: void 0 });
}
...
var { PDFDataRangeTransport: NI } = eI;
var BI = (r, t) => {
  switch (t) {
...
var $I = (0, import_react.forwardRef)(function(t, e) {
  var { children: n, className: i, error: s = "Failed to load PDF file.", externalLinkRel: a, externalLinkTarget: l, file: c, inputRef: d, imageResourcesPath: h, loading: f = "Loading PDF…", noData: g = "No PDF file specified.", onItemClick: v, onLoadError: y, onLoadProgress: E, onLoadSuccess: x, onPassword: _ = BI, onSourceError: P, onSourceSuccess: L, options: k, renderMode: F, rotate: I } = t, M = Uv(t, ["children", "className", "error", "externalLinkRel", "externalLinkTarget", "file", "inputRef", "imageResourcesPath", "loading", "noData", "onItemClick", "onLoadError", "onLoadProgress", "onLoadSuccess", "onPassword", "onSourceError", "onSourceSuccess", "options", "renderMode", "rotate"]);
  const [C, T] = Ko(), { value: O, error: D } = C, [U, j] = Ko(), { value: V, error: Y } = U, Z = (0, import_react.useRef)(new CI()), $ = (0, import_react.useRef)([]), G = (0, import_react.useRef)(void 0), W = (0, import_react.useRef)(void 0);
  ...
  const bt = (0, import_react.useRef)({
    ...
    scrollPageIntoView: (X) => {
      const { dest: vt, pageNumber: Pt, pageIndex: Ht = Pt - 1 } = X;
      if (v) {
        v({ dest: vt, pageIndex: Ht, pageNumber: Pt });
        return;
      }
      const Kt = $.current[Ht];
      if (Kt) {
  ...
  const tt = (0, import_react.useCallback)(() => OI(this, void 0, void 0, function* () {
    if (!c)
      return null;
    if (typeof c == "string")
      return Hm(c) ? { data: $v(c) } : (Hv(), { url: c });
    if (c instanceof NI)
      return { range: c };
    if (RI(c))
      return { data: c };
    ...
    if ($t(typeof c == "object", "Invalid parameter in file, need either Uint8Array, string or a parameter object"), $t(jv(c), "Invalid parameter object: need either .data, .range or .url"), "url" in c && typeof c.url == "string") {
      if (Hm(c.url)) {
        const { url: X } = c, vt = Uv(c, ["url"]), Pt = $v(X);
        return Object.assign({ data: Pt }, vt);
      }
      Hv();
    }
    return c;
  ...
  (0, import_react.useEffect)(() => {
    const X = nd(tt());
    return X.promise.then((vt) => {
      T({ type: "RESOLVE", value: vt });
    }).catch((vt) => {
      T({ type: "REJECT", error: vt });
    }), () => {
      ia(X);
    };
  ...
  function gt() {
    if (!O)
      return;
    const X = Object.assign(Object.assign({}, O), k), vt = g1(X);
    E && (vt.onProgress = E), _ && (vt.onPassword = _);
    const Pt = vt;
    return Pt.promise.then((Ht) => {
      j({ type: "RESOLVE", value: Ht });
    }).catch((Ht) => {
      Pt.destroyed || j({ type: "REJECT", error: Ht });
    }), () => {
      Pt.destroy();
    };
  }
  ...
  (0, import_react.useEffect)(q, [a, l]);
  function J(X, vt) {
    $.current[X] = vt;
  }
  function ht(X) {
  ...
  const ft = (0, import_react.useMemo)(() => ({
    ...
    rotate: I,
    unregisterPage: ht
  }), [h, v, V, F, I]), st = (0, import_react.useMemo)(() => v1(M, () => V), [M, V]);
  function xt() {
    return (0, import_jsx_runtime.jsx)(w1.Provider, { value: ft, children: n });
  }
  function wt() {
    return c ? V == null ? (0, import_jsx_runtime.jsx)(xa, { type: "loading", children: typeof f == "function" ? f() : f }) : V === false ? (0, import_jsx_runtime.jsx)(xa, { type: "error", children: typeof s == "function" ? s() : s }) : xt() : (0, import_jsx_runtime.jsx)(xa, { type: "no-data", children: typeof g == "function" ? g() : g });
  }
...
function R1({ className: r, node: t }) {
  const e = (0, import_react.useMemo)(() => zI(t), [t]), n = (0, import_react.useMemo)(() => !wp(t) || T1(t) ? null : t.children.map((i, s) => (
...
function GI(r) {
  ...
  function x(F) {
    FI(F) || (Ce(false, F.toString()), a && a(F));
  }
  ...
  return (0, import_react.useEffect)(() => k, [k]), (0, import_jsx_runtime.jsx)("canvas", { className: `${n}__canvas`, dir: "ltr", ref: S1(v, y), style: {
    display: "block",
    userSelect: "none"
  }, children: h ? (0, import_jsx_runtime.jsx)(VI, {}) : null });
}
function WI(r) {
  return "str" in r;
}
function qI() {
  ...
  const [f, g] = Ko(), { value: v, error: y } = f, E = (0, import_react.useRef)(null), x = (0, import_react.useRef)(void 0);
  ...
  (0, import_react.useEffect)(L, [a, g]);
  function k() {
    if (!a)
      return;
    const D = nd(a.getTextContent()), U = D;
  ...
  (0, import_react.useEffect)(k, [a, g]), (0, import_react.useEffect)(
    () => {
      if (v !== void 0) {
        if (v === false) {
          P();
  ...
  const T = (0, import_react.useMemo)(() => a.getViewport({ scale: h, rotation: d }), [a, d, h]);
  function O() {
    if (!a || !v)
      return;
    const { current: D } = E;
    if (!D)
      return;
    D.innerHTML = "";
    const U = a.streamTextContent({ includeMarkedContent: true }), j = {
      container: D,
      textContentSource: U,
      viewport: T
    }, V = new p1(j), Y = V;
...
function XI() {
  ...
  const [y, E] = Ko(), { value: x, error: _ } = y, P = (0, import_react.useRef)(null);
  ...
  function I() {
    if (!d)
      return;
    const D = nd(d.getAnnotations()), U = D;
    return D.promise.then((j) => {
  ...
  function O() {
    ...
    if (!D)
      return;
    const U = T.clone({ dontFlip: true }), j = {
...
function KI(r) {
  ...
  (0, import_react.useEffect)(vt, [i, $, st, et]);
  function Pt() {
    if (C) {
      if (!J || !X)
        return;
  ...
  (0, import_react.useEffect)(Gt, [q, $, st, xt, G]), (0, import_react.useEffect)(
    () => {
      if (J !== void 0) {
        if (J === false) {
          Ht();
  ...
  const Lt = (0, import_react.useMemo)(() => (
    ...
    wt,
    X
  ]), kt = (0, import_react.useMemo)(() => v1(K, () => J && (X ? Um(J, X) : void 0)), [K, J, X]), Wt = `${st}@${X}/${wt}`;
  function at() {
    switch (ut) {
      case "custom":
      ...
      case "canvas":
      default:
        return (0, import_jsx_runtime.jsx)(GI, { canvasRef: a }, `${Wt}_canvas`);
    }
  }
  function Re() {
    return z ? (0, import_jsx_runtime.jsx)(qI, {}, `${Wt}_text`) : null;
  }
  function Le() {
    return W ? (0, import_jsx_runtime.jsx)(XI, {}, `${Wt}_annotations`) : null;
  }
  function ce() {
    return (0, import_jsx_runtime.jsxs)(x1.Provider, { value: Lt, children: [at(), Re(), Le(), l] });
  }
  function sn() {
    return xt ? $ === null || J === void 0 || J === null ? (0, import_jsx_runtime.jsx)(xa, { type: "loading", children: typeof E == "function" ? E() : E }) : $ === false || J === false ? (0, import_jsx_runtime.jsx)(xa, { type: "error", children: typeof g == "function" ? g() : g }) : ce() : (0, import_jsx_runtime.jsx)(xa, { type: "no-data", children: typeof x == "function" ? x() : x });
  }
  return (0, import_jsx_runtime.jsx)("div", Object.assign({
    className: yp(n, c),
    "data-page-number": xt,
...
var L1 = "SET_ZOOM_LEVEL";
var eg = (r) => ({
  type: L1,
  value: r
});
var k1 = "SET_PDF_PAGINATED";
var ZI = (r) => ({
  type: k1,
  value: r
});
...
var Qo = (0, import_react.createContext)({ state: Qi, dispatch: () => null });
var QI = ({
  children: r,
  mainState: t
}) => {
  var i, s, a, l, c, d, h;
  const [e, n] = (0, import_react.useReducer)(JI, {
    ...Qi,
  ...
  return (0, import_jsx_runtime.jsx)(Qo.Provider, { value: { state: e, dispatch: n }, children: r });
};
var M1 = ({ pageNum: r }) => {
  const {
    state: { mainState: t, paginated: e, zoomLevel: n, numPages: i, currentPage: s }
  } = (0, import_react.useContext)(Qo), { t: a } = aa(), l = (t == null ? void 0 : t.rendererRect) || null, c = r ?? s;
  return (0, import_jsx_runtime.jsxs)(t2, { id: "pdf-page-wrapper", $lastPage: c >= i, children: [
    !e && (0, import_jsx_runtime.jsx)(e2, { id: "pdf-page-info", children: a("pdfPluginPageNumber", {
      currentPage: c,
      allPagesCount: i
    }) }),
    (0, import_jsx_runtime.jsx)(
...
var n2 = () => {
  const {
    state: { numPages: r }
  } = (0, import_react.useContext)(Qo), t = [];
  for (let e = 0; e < r; e++)
    t.push((0, import_jsx_runtime.jsx)(M1, { pageNum: e + 1 }, e + 1));
...
var i2 = () => {
  const {
    ...
    dispatch: e
  } = (0, import_react.useContext)(Qo), { t: n } = aa(), i = (r == null ? void 0 : r.currentDocument) || null;
  return (0, import_react.useEffect)(() => {
    e(Gv(Qi.numPages));
    ...
    r2,
    {
      ...
      children: t ? (0, import_jsx_runtime.jsx)(M1, {}) : (0, import_jsx_runtime.jsx)(n2, {})
    }
  );
};
var r2 = mt($I)`
  ...
  margin: 0 auto;
`;
var s2 = (r) => (0, import_jsx_runtime.jsx)(D1, { ...r, reverse: true });
var a2 = (r) => (0, import_jsx_runtime.jsx)(D1, { ...r });
var D1 = (r) => {
...
var l2 = (r) => (0, import_jsx_runtime.jsx)(O1, { ...r });
var c2 = (r) => (0, import_jsx_runtime.jsx)(O1, { ...r, reverse: true });
var O1 = (r) => {
  const { color: t, size: e, reverse: n } = r;
  return (0, import_jsx_runtime.jsx)(
    "svg",
...
var u2 = () => {
  const {
    ...
    dispatch: e
  } = (0, import_react.useContext)(Qo), { t: n } = aa();
  return (0, import_jsx_runtime.jsxs)(f2, { id: "pdf-pagination", children: [
    (0, import_jsx_runtime.jsx)(
      N1,
      {
        ...
        onClick: () => e(Wv(r - 1)),
        disabled: r === 1,
        children: (0, import_jsx_runtime.jsx)(s2, { color: "#000", size: "50%" })
      }
    ),
    (0, import_jsx_runtime.jsx)(g2, { id: "pdf-pagination-info", children: n("pdfPluginPageNumber", {
      currentPage: r,
      allPagesCount: t
    }) }),
    (0, import_jsx_runtime.jsx)(
      p2,
      {
        ...
        onClick: () => e(Wv(r + 1)),
        disabled: r >= t,
        children: (0, import_jsx_runtime.jsx)(a2, { color: "#000", size: "50%" })
      }
    )
  ] });
};
...
var m2 = () => {
  const { t: r } = aa(), {
    ...
    dispatch: l
  } = (0, import_react.useContext)(Qo), c = (t == null ? void 0 : t.currentDocument) || null;
  return (0, import_jsx_runtime.jsxs)(v2, { id: "pdf-controls", children: [
    e && i > 1 && (0, import_jsx_runtime.jsx)(u2, {}),
    (c == null ? void 0 : c.fileData) && (0, import_jsx_runtime.jsx)(
      y2,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(o2, { color: "#000", size: "75%" })
      }
    ),
    (0, import_jsx_runtime.jsx)(
      md,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(c2, { color: "#000", size: "80%" })
      }
    ),
    (0, import_jsx_runtime.jsx)(
      md,
      {
        id: "pdf-zoom-in",
        onMouseDown: () => l(eg(n + s)),
        children: (0, import_jsx_runtime.jsx)(l2, { color: "#000", size: "80%" })
      }
    ),
    (0, import_jsx_runtime.jsx)(
      md,
      {
        ...
        onMouseDown: () => l(eg(a)),
        disabled: n === a,
        children: (0, import_jsx_runtime.jsx)(h2, { color: "#000", size: "70%" })
      }
    ),
...
var A0 = ({ mainState: r }) => (0, import_jsx_runtime.jsx)(QI, { mainState: r, children: (0, import_jsx_runtime.jsxs)(b2, { id: "pdf-renderer", "data-testid": "pdf-renderer", children: [
  (0, import_jsx_runtime.jsx)(m2, {}),
  (0, import_jsx_runtime.jsx)(i2, {})
] }) });
...
var w2 = mt(Gi)`
  ...
  background-position:
    ...
    -10px 0px;
`;
var E0 = (r) => (0, import_jsx_runtime.jsx)(w2, { ...r });
...
var C2 = (r, t, e) => {
  ...
  if (s <= 8)
    var l = 24 + e, c = Ui.getUint8(i, en);
  else if (s <= 16)
    var l = 16 + e, c = Ui.getUint16(i, en);
  else if (s <= 32)
    var l = e, c = Ui.getUint32(i, en);
  else
...
var ze = (r, t) => {
  ...
  if (r <= 1)
    return Ui.getUint8(t, en);
  if (r <= 2)
    return Ui.getUint16(t, en);
  if (r <= 3)
    return Ui.getUint32(t, en) >>> 8;
  if (r <= 4)
    return Ui.getUint32(t, en);
...
var P2 = (r, t) => {
  ...
  if (r && (Ui = new DataView(r), en = A2(), !!E2())) {
    var n = ze(4, 4);
    hu = B1(n);
    ...
    if (i.BitsPerSample.values.forEach(function(Wt, at, Re) {
      ...
      }, Wt % 8 === 0 && (h[at].hasBytesPerSample = true, h[at].bytesPerSample = Wt / 8), f += Wt;
    }, void 0), f % 8 === 0) {
      g = true;
      var v = f / 8;
    }
    ...
    for (var _ = 0; _ < E; _++) {
      var P = y[_];
      l[_] = [];
      for (var L = x[_], k = 0, F = 0, I = 1, M = true, C = [], T = 0, O = 0, D = 0; k < L; k += I)
        switch (c) {
          case 1:
            for (var U = 0, C = []; U < d; U++)
              if (h[U].hasBytesPerSample) {
                var j = h[U].bytesPerSample * U;
                C.push(
                  ze(
                    h[U].bytesPerSample,
                    P + k + j
          ...
          case 32773:
            if (M) {
              M = false;
              var Y = 1, Z = 1, $ = Ui.getInt8(
                P + k,
                en
              );
              $ >= 0 && $ <= 127 ? Y = $ + 1 : $ >= -127 && $ <= -1 ? Z = -$ + 1 : M = true;
            } else {
              for (var G = ze(1, P + k), U = 0; U < Z; U++) {
      ...
      for (var _ = 0; _ < ut; _++) {
        ...
        for (var ht = l[_].length, ft = et * _, st = 0, xt = 0; xt < ht; st++)
          for (var wt = 0; wt < s; wt++, xt++) {
            var X = l[_][xt], vt = 0, Pt = 0, Ht = 0, Kt = 1;
            if (gt > 0) {
            ...
            W.fillStyle = qv(vt, Pt, Ht, Kt), W.fillRect(wt, ft + st, 1, 1);
          }
        et = tt;
      }
    }
...
var Ep = (r) => {
  const {
    mainState: { currentDocument: t }
  } = r, { t: e } = aa(), [n, i] = (0, import_react.useState)(false), [s, a] = (0, import_react.useState)(false);
  return (0, import_react.useEffect)(() => {
    if (!t || n)
      return;
    const l = document.getElementById("tiff-img");
    try {
      l && P2(t.fileData, l), i(true);
    } catch {
      a(true);
    }
  }, [t, n]), s ? (0, import_jsx_runtime.jsx)(Gi, { ...r, children: (0, import_jsx_runtime.jsx)("div", { children: e("brokenFile") }) }) : (0, import_jsx_runtime.jsx)(Gi, { ...r, children: (0, import_jsx_runtime.jsx)(R2, { id: "tiff-img" }) });
};
...
var R2 = mt.canvas`
  ...
  max-height: 95%;
`;
var _p = ({ mainState: { currentDocument: r } }) => (0, import_jsx_runtime.jsx)(L2, { id: "txt-renderer", children: r == null ? void 0 : r.fileData });
...
(function(r, t) {
  (function(e, n) {
    ...
    var n = typeof self < "u" ? self : typeof window < "u" ? window : n !== void 0 ? n : {}, i = !n.document && !!n.postMessage, s = n.IS_PAPA_WORKER || false, a = {}, l = 0, c = { parse: function(C, T) {
      ...
      }(C), U = T.download ? new f(T) : new v(T)) : C.readable === true && M(C.read) && M(C.on) ? U = new y(T) : (n.File && C instanceof File || C instanceof Object) && (U = new g(T)), U.stream(C);
    }, unparse: function(C, T) {
      var O = false, D = true, U = ",", j = `\r
`, V = '"', Y = V + V, Z = false, $ = null, G = false;
      (function() {
        if (typeof T == "object") {
      ...
      function ut(z, nt) {
        ...
        var tt = false;
        G && typeof z == "string" && G.test(z) && (z = "'" + z, tt = true);
        ...
        return (tt = tt || O === true || typeof O == "function" && O(z, nt) || Array.isArray(O) && O[nt] || function(lt, K) {
          for (var gt = 0; gt < K.length; gt++)
            if (-1 < lt.indexOf(K[gt]))
              return true;
          return false;
        }(et, c.BAD_DELIMITERS) || -1 < et.indexOf(U) || et.charAt(0) === " " || et.charAt(et.length - 1) === " ") ? V + et + V : et;
      }
    } };
...
`, '"', c.BYTE_ORDER_MARK], c.WORKERS_SUPPORTED = !i && !!n.Worker, c.NODE_STREAM_INPUT = 1, c.LocalChunkSize = 10485760, c.RemoteChunkSize = 5242880, c.DefaultDelimiter = ",", c.Parser = _, c.ParserHandle = E, c.NetworkStreamer = f, c.FileStreamer = g, c.StringStreamer = v, c.ReadableStreamStreamer = y, n.jQuery) {
    ...
    function h(C) {
      this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = { data: [], errors: [], meta: {} }, (function(T) {
        ...
        this._partialLine = "";
        var j = this._handle.parse(U, this._baseIndex, !this._finished);
        if (!this._handle.paused() && !this._handle.aborted()) {
          var V = j.meta.cursor;
          this._finished || (this._partialLine = U.substring(V - this._baseIndex), this._baseIndex = V), j && j.data && (this._rowCount += j.data.length);
    ...
    function g(C) {
      ...
      this.stream = function(U) {
        this._input = U, O = U.slice || U.webkitSlice || U.mozSlice, D ? ((T = new FileReader()).onload = I(this._chunkLoaded, this), T.onerror = I(this._chunkError, this)) : T = new FileReaderSync(), this._nextChunk();
    ...
    function y(C) {
      ...
      this.pause = function() {
        ...
        try {
          T.push(typeof U == "string" ? U : U.toString(this._config.encoding)), O && (O = false, this._checkIsFinished(), this.parseChunk(T.shift()));
        } catch (j) {
          this._streamError(j);
        }
    ...
    function E(C) {
      var T, O, D, U = Math.pow(2, 53), j = -U, V = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, Y = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, Z = this, $ = 0, G = 0, W = false, bt = false, ut = [], z = { data: [], errors: [], meta: {} };
      if (M(C.step)) {
        var nt = C.step;
        C.step = function(q) {
          if (z = q, lt())
      ...
      this.parse = function(q, J, ht) {
        ...
        if (C.newline || (C.newline = function(wt, X) {
          ...
          var vt = new RegExp(x(X) + "([^]*?)" + x(X), "gm"), Pt = (wt = wt.replace(vt, "")).split("\r"), Ht = wt.split(`
`), Kt = 1 < Ht.length && Ht[0].length < Pt[0].length;
          if (Pt.length === 1 || Kt)
            return `
`;
...
` : "\r";
    ...
    function _(C) {
      var T, O = (C = C || {}).delimiter, D = C.newline, U = C.comments, j = C.step, V = C.preview, Y = C.fastMode, Z = T = C.quoteChar === void 0 || C.quoteChar === null ? '"' : C.quoteChar;
      if (C.escapeChar !== void 0 && (Z = C.escapeChar), (typeof O != "string" || -1 < c.BAD_DELIMITERS.indexOf(O)) && (O = ","), U === O)
        throw new Error("Comment character same as delimiter");
      U === true ? U = "#" : (typeof U != "string" || -1 < c.BAD_DELIMITERS.indexOf(U)) && (U = false), D !== `
` && D !== "\r" && D !== `\r
` && (D = `
`);
      var $ = 0, G = false;
      this.parse = function(W, bt, ut) {
        ...
        var z = W.length, nt = O.length, tt = D.length, et = U.length, lt = M(j), K = [], gt = [], q = [], J = $ = 0;
        if (!W)
          return p();
        if (C.header && !bt) {
          ...
          for (var wt in ht) {
            ...
            var vt = X, Pt = st[X] || 0;
            for (0 < Pt && (xt = true, vt = X + "_" + Pt), st[X] = Pt + 1; ft.includes(vt); )
              vt = vt + "_" + Pt;
            ft.push(vt);
          }
          if (xt) {
            var Ht = W.split(D);
            Ht[0] = ft.join(O), W = Ht.join(D);
          }
        }
        ...
        for (var Lt = W.indexOf(O, $), kt = W.indexOf(D, $), Wt = new RegExp(x(Z) + x(T), "g"), at = W.indexOf(T, $); ; )
          if (W[$] !== T)
            if (U && q.length === 0 && W.substring($, $ + et) === U) {
              if (kt === -1)
                return p();
    ...
    function P(C) {
      var T = C.data, O = a[T.workerId], D = false;
      if (T.error)
        O.userError(T.error, T.file);
      else if (T.results && T.results.data) {
        var U = { abort: function() {
          D = true, L(T.workerId, { data: [], errors: [], meta: { aborted: true } });
        }, pause: k, resume: k };
        if (M(O.userStep)) {
          for (var j = 0; j < T.results.data.length && (O.userStep({ data: T.results.data[j], errors: T.results.errors, meta: T.results.meta }, U), !D); j++)
            ;
          delete T.results;
        } else
          M(O.userChunk) && (O.userChunk(T.results, U, T.file), delete T.results);
      }
...
var Sp = ({
  ...
  }, [r, t == null ? void 0 : t.csvDelimiter]), e.length ? (0, import_jsx_runtime.jsx)(F2, { children: (0, import_jsx_runtime.jsxs)(M2, { children: [
...
`;
var _0 = (r) => (0, import_jsx_runtime.jsx)(Gi, { ...r });
_0.fileTypes = ["gif", "image/gif"];
_0.weight = 0;
var S0 = ({ mainState: { currentDocument: r } }) => r ? (0, import_jsx_runtime.jsx)(D2, { id: "video-renderer", children: (0, import_jsx_runtime.jsx)(O2, { controls: true, src: r.uri }) }) : null;
...
var O2 = mt.video`
  ...
  border: 0;
`;
var x0 = (r) => (0, import_jsx_runtime.jsx)(Gi, { ...r });
...
var B2 = (0, import_react.forwardRef)((r, t) => {
...
@cyntler/react-doc-viewer/dist/index-Cfl95pw4.js:
  (*!
  ...
  *)
*/
//# sourceMappingURL=chunk-AD3H7H7S.js.map
